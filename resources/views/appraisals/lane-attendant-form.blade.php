...
<body class="min-h-screen bg-gray-50">
    ...
    <script>
        ...
        function calculateWeightTotal() {
            ...
            // Update all displays
            const weightDisplay = document.getElementById('laneTotalWeight');
            const weightStatsDisplay = document.getElementById('laneTotalWeightDisplay');
        ...
        function submitForm() {
            ...
            if (safetyWarning !== '') {
                if (!confirm('Safety acknowledgements not completed:\n\n' + safetyWarning + '\nAre you sure you want to continue without safety acknowledgements?')) {
                    return;
                }
            }
            ...
            if (confirm(confirmationMessage)) {
                document.getElementById('laneFormStatus').value = 'submitted';
