...
<head>
    ...
    <title>Toll Collector Performance Appraisal - MOIC Performance Appraisal System</title>
    ...
    <style>
        /* MOIC Brand Colors - Toll Collector Theme (Frontline Operations) */
        :root {
            --moic-navy: #110484;
...
<body>
            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex align-items-center desktop-only">
                        ...
                        <div>
                            <h1 class="h5 mb-0 fw-bold" style="font-size: 1rem;">Toll Collector Performance Appraisal</h1>
                            <p class="mb-0 text-white-50" style="font-size: 0.75rem;">{{ $currentQuarter }} {{ $quarterInfo->year }}</p>
                        </div>
                    </div>
                    
                    <div class="mobile-only ms-2">
                        <h1 class="h6 mb-0 fw-bold">Toll Collector</h1>
                ...
                <div class="d-flex align-items-center gap-2">
                    <div class="desktop-only text-end me-2">
                        ...
                        <div class="small text-white-50">Toll Collector</div>
                    </div>
    ...
    <div class="container-custom px-3">
        <div class="cash-handling-section">
            <div class="d-flex">
                <div class="flex-shrink-0">
                    <i class="fas fa-hand-holding-usd fa-2x me-3" style="color: #92400e;"></i>
                </div>
                <div>
                    <h5 class="fw-bold mb-2" style="color: #92400e;">💰 Cash Handling Guidelines</h5>
                    <p class="mb-0">Accuracy in cash handling is critical. Always count carefully, verify amounts, and report any discrepancies immediately. Never leave cash unattended. Follow all cash security procedures without exception.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-custom px-3">
        <div class="customer-tip">
            <div class="d-flex">
                <div class="flex-shrink-0">
                    <i class="fas fa-smile fa-2x me-3" style="color: #059669;"></i>
                </div>
                <div>
                    <h5 class="fw-bold mb-2" style="color: #059669;">😊 Customer Service Excellence</h5>
                    <p class="mb-0">Remember to greet every customer with a smile, process transactions efficiently, and thank them as they leave. Your positive attitude creates a better experience for everyone.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <main class="py-4">
        <div class="container-custom px-3">
            ...
            <!-- Main Form -->
            <form id="tollCollectorForm" action="{{ route('appraisals.store') }}" method="POST" class="card card-moic">
                @csrf
                <input type="hidden" name="status" id="tollFormStatus" value="draft">
                <input type="hidden" name="period" value="{{ $currentQuarter }}">
                <input type="hidden" name="start_date" value="{{ $startDate }}">
                <input type="hidden" name="end_date" value="{{ $endDate }}">
                <input type="hidden" name="job_title" value="Toll Collector">
                ...
                <div class="card-body">
                            ...
                            <div class="bg-blue-50 p-3 rounded">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <p id="tollTotalWeightDisplay" class="h4 fw-bold moic-navy mb-0">100%</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="weight-cell">
                                        ...
                                        <input type="hidden" name="kpas[0][weight]" value="5">
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td class="weight-cell">
                                        ...
                                        <input type="hidden" name="kpas[1][weight]" value="20">
                                    </td>
                                    <td>
                                ...
                                <!-- WORK PERFORMANCE - Toll Collection -->
                                <tr>
                                    <td class="fw-medium">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                WORK PERFORMANCE
                                                <small class="text-muted d-block">Toll Collection</small>
                                            </div>
                                        </div>
                                        <input type="hidden" name="kpas[2][category]" value="WORK PERFORMANCE">
                                        <input type="hidden" name="kpas[2][kpa]" value="Toll Collection">
                                        <input type="hidden" name="kpas[2][result_indicators]" value="Accurate and efficient toll collection with minimal errors and high transaction speed">
                                    </td>
                                    <td>
                                        <div class="small">Accurate and efficient toll collection with minimal errors and high transaction speed 
                                            <span class="revenue-badge">REVENUE</span>
                                            <span class="frontline-badge">FRONTLINE</span>
                                        </div>
                                        <div class="mt-1">
                                    ...
                                    <td class="weight-cell">
                                        ...
                                        <input type="hidden" name="kpas[2][weight]" value="25">
                                    </td>
                                    <td>
                                ...
                                <!-- WORK PERFORMANCE - Cash Handling -->
                                <tr>
                                    <td class="fw-medium">
                                        <div class="d-flex align-items-center">
                                            <div class="bg-purple-100 text-purple-600 p-2 rounded me-2">
                                            ...
                                            <div>
                                                WORK PERFORMANCE
                                                <small class="text-muted d-block">Cash Handling</small>
                                            </div>
                                        </div>
                                        <input type="hidden" name="kpas[3][category]" value="WORK PERFORMANCE">
                                        <input type="hidden" name="kpas[3][kpa]" value="Cash Handling">
                                        <input type="hidden" name="kpas[3][result_indicators]" value="Secure and accurate cash handling with proper counting and recording procedures">
                                    </td>
                                    <td>
                                        <div class="small">Secure and accurate cash handling with proper counting and recording procedures</div>
                                        <div class="mt-1">
                                            <span class="badge bg-gray-100 text-gray-800 me-1">ND - 1</span>
                                            <span class="badge bg-gray-100 text-gray-800 me-1">NS - 2</span>
                                            <span class="badge bg-gray-100 text-gray-800 me-1">S - 3</span>
                                ...
                                <!-- WORK PERFORMANCE - Customer Service -->
                                <tr>
                                    <td class="fw-medium">
                                        <div class="d-flex align-items-center">
                                            <div class="bg-purple-100 text-purple-600 p-2 rounded me-2">
                                        ...
                                        <input type="hidden" name="kpas[4][kpa]" value="Customer Service">
                                        <input type="hidden" name="kpas[4][result_indicators]" value="Provide excellent customer service, handle queries professionally, and maintain positive customer interactions">
                                    </td>
                                    <td>
                                        <div class="small">Provide excellent customer service, handle queries professionally, and maintain positive customer interactions 
                                ...
                                <!-- WORK PERFORMANCE - Lane Management -->
                                <tr>
                                    <td class="fw-medium">
                                        <div class="d-flex align-items-center">
                                            <div class="bg-purple-100 text-purple-600 p-2 rounded me-2">
                                            ...
                                            <div>
                                                WORK PERFORMANCE
                                                <small class="text-muted d-block">Lane Management</small>
                                            </div>
                                        </div>
                                        <input type="hidden" name="kpas[5][category]" value="WORK PERFORMANCE">
                                        <input type="hidden" name="kpas[5][kpa]" value="Lane Management">
                                        <input type="hidden" name="kpas[5][result_indicators]" value="Maintain lane cleanliness and operational readiness, report any equipment issues promptly">
                                    </td>
                                    <td>
                                        <div class="small">Maintain lane cleanliness and operational readiness, report any equipment issues promptly</div>
                                        <div class="mt-1">
                                            <span class="badge bg-gray-100 text-gray-800 me-1">ND - 1</span>
                                            <span class="badge bg-gray-100 text-gray-800 me-1">NS - 2</span>
                                            <span class="badge bg-gray-100 text-gray-800 me-1">S - 3</span>
                        ...
                        <div class="col-12">
                            <div class="bg-gray-50 p-4 rounded border">
                                ...
                                <div class="mb-2 d-flex justify-content-between">
                                    ...
                                    <span id="tollTotalWeight" class="fw-bold moic-navy">100%</span>
                                </div>
                                <div class="progress-moic">
                                    <div id="tollWeightProgress" class="progress-bar-moic" style="width: 100%; height: 100%;"></div>
                                </div>
                                <div id="tollWeightStatus" class="mt-2 small text-success">
                    ...
                    <div class="alert alert-info mb-4" role="alert">
                        ...
                        <strong>End of Shift Reminder:</strong> Remember to complete your cash reconciliation, submit your collections, and document any incidents or equipment issues in the shift log before leaving.
                    </div>
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            <div class="bg-blue-50 p-4 rounded border">
                                ...
                                <textarea name="development_needs" rows="4" class="form-control" placeholder="List your development needs for the next period (e.g., customer service skills, cash handling accuracy, transaction speed, communication skills)..."></textarea>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="bg-green-50 p-4 rounded border">
                                ...
                                <textarea name="employee_comments" rows="4" class="form-control" placeholder="Any additional comments or feedback about your performance, challenges faced, customer interactions, or suggestions for improvement..."></textarea>
                            </div>
                        </div>
                    </div>
    ...
    // Fixed weights for Toll Collector - sums to 100% (5+20+25+20+15+10+5 = 100)
    const weights = [5, 20, 25, 20, 15, 10, 5];
    ...
    function calculateWeightTotal() {
        ...
        // Update all displays
        const weightDisplay = document.getElementById('tollTotalWeight');
        const weightStatsDisplay = document.getElementById('tollTotalWeightDisplay');
        const progressBar = document.getElementById('tollWeightProgress');
        const statusDiv = document.getElementById('tollWeightStatus');
    ...
    function saveAsDraft(event) {
        ...
        document.getElementById('tollFormStatus').value = 'draft';
        ...
        setTimeout(() => {
            document.getElementById('tollCollectorForm').submit();
        }, 1500);
    }
    ...
    function submitForm(event) {
        ...
        if (confirm(confirmMessage)) {
            document.getElementById('tollFormStatus').value = 'submitted';
