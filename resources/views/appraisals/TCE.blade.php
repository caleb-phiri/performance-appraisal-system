...
<head>
    ...
    <title>TCE Technician Performance Appraisal - MOIC</title>
...
<body class="min-h-screen bg-gray-50">
                ...
                <div class="flex justify-between items-start">
                    <div class="flex-1">
                        <div class="flex items-center mb-3">
                            ...
                            <div>
                                <h1 class="text-2xl font-bold mb-1">TCE Technician - Performance Appraisal</h1>
                        ...
                        <div class="flex flex-wrap gap-4 mt-4">
                            ...
                            <div class="bg-white/10 backdrop-blur-sm rounded-lg px-3 py-2">
                                ...
                                <p class="font-semibold text-white">Maintenance Supervisor</p>
                            </div>
                        </div>
                    </div>
    ...
    <main class="max-w-7xl mx-auto">
        <form id="tceTechnicianForm" action="{{ route('appraisals.store') }}" method="POST" class="bg-white rounded-lg shadow-lg p-6 border border-gray-200">
            @csrf
                ...
                <div class="bg-gradient-to-r from-green-50 to-emerald-50 border border-emerald-100 rounded-lg p-4">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p id="tceTotalWeightDisplay" class="text-lg font-bold text-gray-800">100%</p>
                        </div>
                    </div>
                </div>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="kpa-row hover:bg-purple-50/50 transition duration-150">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <span class="text-xs text-gray-500">Daily Inspection</span>
                                    </div>
                                </div>
                            ...
                            <td class="px-6 py-4">
                                <div class="text-sm text-gray-900 font-medium">Daily inspection of toll equipment, identify and record any faults or irregularities in a timely manner 
                        ...
                        <tr class="kpa-row hover:bg-purple-50/50 transition duration-150">
                            ...
                            <td class="px-6 py-4">
                                <div class="text-sm text-gray-900 font-medium">Perform routine maintenance and minor repairs based on vendor or internal standards to ensure stable operation 
                        ...
                        <tr class="kpa-row hover:bg-purple-50/50 transition duration-150">
                            ...
                            <td class="px-6 py-4">
                                <div class="text-sm text-gray-900 font-medium">Submit monthly reports summarizing equipment performance, inspection findings, and resolution progress</div>
                                <div class="text-xs text-gray-500 mt-1">
                                    <span class="inline-block px-2 py-1 bg-gray-100 rounded">ND - 1 point</span>
                                    <span class="inline-block px-2 py-1 bg-gray-100 rounded">NS - 2 points</span>
                                    <span class="inline-block px-2 py-1 bg-gray-100 rounded">S - 3 points</span>
                        ...
                        <tr class="kpa-row hover:bg-purple-50/50 transition duration-150">
                            ...
                            <td class="px-6 py-4">
                                <div class="text-sm text-gray-900 font-medium">Scheduled cleaning of toll equipment, ensuring they remain free of dust and in good visual condition</div>
                                <div class="text-xs text-gray-500 mt-1">
                                    <span class="inline-block px-2 py-1 bg-gray-100 rounded">ND - 1 point</span>
                                    <span class="inline-block px-2 py-1 bg-gray-100 rounded">NS - 2 points</span>
                                    <span class="inline-block px-2 py-1 bg-gray-100 rounded">S - 3 points</span>
                        ...
                        <tr class="kpa-row hover:bg-purple-50/50 transition duration-150">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        <span class="font-semibold text-gray-900">WORK PERFORMANCE</span><br>
                                        <span class="text-xs text-gray-500">Emergency Response</span>
                                    </div>
                                </div>
                            ...
                            <td class="px-6 py-4">
                                <div class="text-sm text-gray-900 font-medium">Promptly respond to emergencies and action in case of toll equipment failures or assist in urgent repairs 
                ...
                <div class="space-y-4">
                    <div>
                        <div class="flex justify-between items-center mb-2">
                            ...
                            <span id="tceTotalWeight" class="text-lg font-bold text-[#110484]">100%</span>
                        </div>
                        <div class="w-full bg-gray-200 rounded-full h-3 progress-bar">
                            <div id="tceWeightProgress" class="bg-gradient-to-r from-green-500 to-emerald-500 h-3 rounded-full transition-all duration-500" style="width: 100%"></div>
                        </div>
                    </div>
                    <div id="tceWeightStatus" class="flex items-center text-sm font-semibold text-green-600">
    ...
    <script>
        ...
        function calculateScores() {
            const form = document.getElementById('tceTechnicianForm');
