...
<head>
    ...
    <title>TCE Technician Performance Appraisal - MOIC Performance Appraisal System</title>
    ...
    <style>
        /* MOIC Brand Colors - TCE Technician Theme (Technical/Emergency) */
        :root {
            --moic-navy: #110484;
...
<body>
            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex align-items-center desktop-only">
                        ...
                        <div>
                            <h1 class="h5 mb-0 fw-bold" style="font-size: 1rem;">TCE Technician Performance Appraisal</h1>
                            <p class="mb-0 text-white-50" style="font-size: 0.75rem;">{{ $currentQuarter }} {{ $quarterInfo->year }}</p>
                        </div>
                    </div>
                    
                    <div class="mobile-only ms-2">
                        <h1 class="h6 mb-0 fw-bold">TCE Technician</h1>
                ...
                <div class="d-flex align-items-center gap-2">
                    <div class="desktop-only text-end me-2">
                        ...
                        <div class="small text-white-50">TCE Technician</div>
                    </div>
    ...
    <main class="py-4">
        <div class="container-custom px-3">
                    ...
                    <div class="stat-card">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p class="fw-semibold mb-0">Maintenance Supervisor</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- Main Form -->
            <form id="tceTechnicianForm" action="{{ route('appraisals.store') }}" method="POST" class="card card-moic">
                @csrf
                <input type="hidden" name="status" id="tceFormStatus" value="draft">
                <input type="hidden" name="period" value="{{ $currentQuarter }}">
                <input type="hidden" name="start_date" value="{{ $startDate }}">
                <input type="hidden" name="end_date" value="{{ $endDate }}">
                <input type="hidden" name="job_title" value="TCE Technician">
                ...
                <div class="card-body">
                            ...
                            <div class="bg-blue-50 p-3 rounded">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <p id="tceTotalWeightDisplay" class="h4 fw-bold moic-navy mb-0">100%</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="emergency-section mb-4">
                        <div class="d-flex align-items-start gap-3">
                            <i class="fas fa-exclamation-circle fa-2x mt-1" style="color: #92400e;"></i>
                            <div>
                                <h6 class="fw-bold mb-2">Emergency Response Protocol</h6>
                                <p class="small text-muted mb-0">As a TCE Technician, you may be called upon to respond to equipment emergencies outside of normal working hours. Your response time and effectiveness in resolving critical issues directly impacts toll collection operations and customer satisfaction.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="table-responsive mb-4">
                        <table class="table table-moic mb-0">
                            ...
                            <tbody>
                                ...
                                <!-- WORK PERFORMANCE - Daily Inspection -->
                                <tr>
                                    <td class="fw-medium">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                WORK PERFORMANCE
                                                <small class="text-muted d-block">Daily Inspection</small>
                                            </div>
                                        </div>
                                        <input type="hidden" name="kpas[2][category]" value="WORK PERFORMANCE">
                                        <input type="hidden" name="kpas[2][kpa]" value="Daily Inspection">
                                        <input type="hidden" name="kpas[2][result_indicators]" value="Daily inspection of toll equipment, identify and record any faults or irregularities in a timely manner">
                                    </td>
                                    <td>
                                        <div class="small">Daily inspection of toll equipment, identify and record any faults or irregularities in a timely manner 
                                ...
                                <tr>
                                    <td class="fw-medium">
                                        ...
                                        <input type="hidden" name="kpas[3][kpa]" value="Maintenance">
                                        <input type="hidden" name="kpas[3][result_indicators]" value="Perform routine maintenance and minor repairs based on vendor or internal standards to ensure stable operation">
                                    </td>
                                    <td>
                                        <div class="small">Perform routine maintenance and minor repairs based on vendor or internal standards to ensure stable operation 
                                            <span class="technical-badge">CORE FUNCTION</span>
                                        </div>
                                        <div class="mt-1">
                                            <span class="badge bg-gray-100 text-gray-800 me-1">ND - 1</span>
                                            <span class="badge bg-gray-100 text-gray-800 me-1">NS - 2</span>
                                ...
                                <tr>
                                    <td class="fw-medium">
                                        ...
                                        <input type="hidden" name="kpas[4][kpa]" value="Reporting">
                                        <input type="hidden" name="kpas[4][result_indicators]" value="Submit monthly reports summarizing equipment performance, inspection findings, and resolution progress">
                                    </td>
                                    <td>
                                        <div class="small">Submit monthly reports summarizing equipment performance, inspection findings, and resolution progress</div>
                                        <div class="mt-1">
                                            <span class="badge bg-gray-100 text-gray-800 me-1">ND - 1</span>
                                            <span class="badge bg-gray-100 text-gray-800 me-1">NS - 2</span>
                                            <span class="badge bg-gray-100 text-gray-800 me-1">S - 3</span>
...
<tr>
    <td class="fw-medium">
        ...
        <input type="hidden" name="kpas[5][kpa]" value="Cleaning">
        <input type="hidden" name="kpas[5][result_indicators]" value="Scheduled cleaning of toll equipment, ensuring they remain free of dust and in good visual condition">
    </td>
    <td>
        <div class="small">Scheduled cleaning of toll equipment, ensuring they remain free of dust and in good visual condition</div>
        <div class="mt-1">
            <span class="badge bg-gray-100 text-gray-800 me-1">ND - 1</span>
            <span class="badge bg-gray-100 text-gray-800 me-1">NS - 2</span>
            <span class="badge bg-gray-100 text-gray-800 me-1">S - 3</span>
    ...
    <td>
        <div class="d-flex flex-column gap-2">
            ...
            <input type="hidden" name="kpas[5][comments]" id="commentInput5" value="">
                                ...
                                <!-- WORK PERFORMANCE - Emergency Response -->
                                <tr>
                                    <td class="fw-medium">
                                        <div class="d-flex align-items-center">
                                            <div class="bg-purple-100 text-purple-600 p-2 rounded me-2">
                                            ...
                                            <div>
                                                WORK PERFORMANCE
                                                <small class="text-muted d-block">Emergency Response</small>
                                            </div>
                                        </div>
                                        <input type="hidden" name="kpas[6][category]" value="WORK PERFORMANCE">
                                        <input type="hidden" name="kpas[6][kpa]" value="Emergency Response">
                                        <input type="hidden" name="kpas[6][result_indicators]" value="Promptly respond to emergencies and action in case of toll equipment failures or assist in urgent repairs">
                                    </td>
                                    <td>
                                        <div class="small">Promptly respond to emergencies and action in case of toll equipment failures or assist in urgent repairs 
                        ...
                        <div class="col-12">
                            <div class="bg-gray-50 p-4 rounded border">
                                ...
                                <div class="mb-2 d-flex justify-content-between">
                                    ...
                                    <span id="tceTotalWeight" class="fw-bold moic-navy">100%</span>
                                </div>
                                <div class="progress-moic">
                                    <div id="tceWeightProgress" class="progress-bar-moic" style="width: 100%; height: 100%;"></div>
                                </div>
                                <div id="tceWeightStatus" class="mt-2 small text-success">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            <div class="bg-blue-50 p-4 rounded border">
                                ...
                                <textarea name="development_needs" rows="4" class="form-control" placeholder="List your development needs for the next period (e.g., advanced equipment training, safety certifications, electrical troubleshooting skills, new technology training)..."></textarea>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="bg-green-50 p-4 rounded border">
                                ...
                                <textarea name="employee_comments" rows="4" class="form-control" placeholder="Any additional comments or feedback about your performance, equipment issues encountered, safety concerns, or suggestions for improvement..."></textarea>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        const weights = [10, 25, 15, 15, 10, 10, 10, 5]; // Fixed weights for TCE Technician
        ...
        function calculateWeightTotal() {
            const totalWeight = 100; // Fixed at 100% for TCE Technician
            
            // Update all displays
            const weightDisplay = document.getElementById('tceTotalWeight');
            const weightStatsDisplay = document.getElementById('tceTotalWeightDisplay');
            const progressBar = document.getElementById('tceWeightProgress');
            const statusDiv = document.getElementById('tceWeightStatus');
        ...
        function saveAsDraft(event) {
            ...
            document.getElementById('tceFormStatus').value = 'draft';
            ...
            setTimeout(() => {
                document.getElementById('tceTechnicianForm').submit();
            }, 1500);
        }
        ...
        function submitForm(event) {
            ...
            if (confirm(confirmationMessage)) {
                document.getElementById('tceFormStatus').value = 'submitted';
