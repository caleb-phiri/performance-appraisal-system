...
<head>
    ...
    <title>Admin Clerk Performance Appraisal - MOIC Performance Appraisal System</title>
...
<body>
            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex align-items-center desktop-only">
                        ...
                        <div>
                            <h1 class="h5 mb-0 fw-bold" style="font-size: 1rem;">Admin Clerk Performance Appraisal</h1>
                            <p class="mb-0 text-white-50" style="font-size: 0.75rem;">{{ $currentQuarter }} {{ $quarterInfo->year }}</p>
                        </div>
                    </div>
                    
                    <div class="mobile-only ms-2">
                        <h1 class="h6 mb-0 fw-bold">Admin Clerk</h1>
                ...
                <div class="d-flex align-items-center gap-2">
                    <div class="desktop-only text-end me-2">
                        ...
                        <div class="small text-white-50">Admin Clerk</div>
                    </div>
    ...
    <main class="py-4">
        <div class="container-custom px-3">
            ...
            <!-- Main Form -->
            <form id="adminClerkForm" action="{{ route('appraisals.store') }}" method="POST" class="card card-moic">
                @csrf
                <input type="hidden" name="status" id="adminFormStatus" value="draft">
                <input type="hidden" name="period" value="{{ $currentQuarter }}">
                <input type="hidden" name="start_date" value="{{ $startDate }}">
                <input type="hidden" name="end_date" value="{{ $endDate }}">
                <input type="hidden" name="job_title" value="Admin Clerk">
                ...
                <div class="card-header bg-white border-bottom bg-gray-50">
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                        ...
                        <span class="badge bg-gradient" style="background: var(--moic-gradient); color: white; padding: 0.5rem 1rem;">
                            <i class="fas fa-user-tie me-1"></i> Administrative Position
                        </span>
                    </div>
                </div>
                            ...
                            <div class="bg-blue-50 p-3 rounded">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <p id="adminTotalWeightDisplay" class="h4 fw-bold moic-navy mb-0">100%</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="table-responsive mb-4">
                        <table class="table table-moic mb-0">
                            ...
                            <tbody>
                                ...
                                <!-- WORK PERFORMANCE - Document Management -->
                                <tr>
                                    <td class="fw-medium">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                WORK PERFORMANCE
                                                <small class="text-muted d-block">Document Management</small>
                                            </div>
                                        </div>
                                        <input type="hidden" name="kpas[2][category]" value="WORK PERFORMANCE">
                                        <input type="hidden" name="kpas[2][kpa]" value="Document Management">
                                        <input type="hidden" name="kpas[2][result_indicators]" value="Maintain organized filing systems for all administrative documents, ensuring easy retrieval and proper documentation">
                                    </td>
                                    <td>
                                        <div class="small">Maintain organized filing systems for all administrative documents, ensuring easy retrieval and proper documentation 
                                ...
                                <tr>
                                    <td class="fw-medium">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                WORK PERFORMANCE
                                                <small class="text-muted d-block">Data Entry</small>
                                            </div>
                                        </div>
                                        <input type="hidden" name="kpas[3][category]" value="WORK PERFORMANCE">
                                        <input type="hidden" name="kpas[3][kpa]" value="Data Entry">
                                        <input type="hidden" name="kpas[3][result_indicators]" value="Accurate and timely data entry for daily toll collections, staff attendance, and other operational records">
                                    </td>
                                    <td>
                                        <div class="small">Accurate and timely data entry for daily toll collections, staff attendance, and other operational records</div>
                                        <div class="mt-1">
                                            <span class="badge bg-gray-100 text-gray-800 me-1">ND - 1</span>
                                            <span class="badge bg-gray-100 text-gray-800 me-1">NS - 2</span>
                                            <span class="badge bg-gray-100 text-gray-800 me-1">S - 3</span>
                                ...
                                <!-- WORK PERFORMANCE - Report Preparation -->
                                <tr>
                                    <td class="fw-medium">
                                        <div class="d-flex align-items-center">
                                            <div class="bg-purple-100 text-purple-600 p-2 rounded me-2">
                                            ...
                                            <div>
                                                WORK PERFORMANCE
                                                <small class="text-muted d-block">Report Preparation</small>
                                            </div>
                                        </div>
                                        <input type="hidden" name="kpas[4][category]" value="WORK PERFORMANCE">
                                        <input type="hidden" name="kpas[4][kpa]" value="Report Preparation">
                                        <input type="hidden" name="kpas[4][result_indicators]" value="Prepare and submit daily, weekly, and monthly administrative reports as per schedule">
                                    </td>
                                    <td>
                                        <div class="small">Prepare and submit daily, weekly, and monthly administrative reports as per schedule</div>
                                        <div class="mt-1">
                                            <span class="badge bg-gray-100 text-gray-800 me-1">ND - 1</span>
                                            <span class="badge bg-gray-100 text-gray-800 me-1">NS - 2</span>
                                            <span class="badge bg-gray-100 text-gray-800 me-1">S - 3</span>
                                ...
                                <!-- WORK PERFORMANCE - Correspondence -->
                                <tr>
                                    <td class="fw-medium">
                                        <div class="d-flex align-items-center">
                                            <div class="bg-purple-100 text-purple-600 p-2 rounded me-2">
                                            ...
                                            <div>
                                                WORK PERFORMANCE
                                                <small class="text-muted d-block">Correspondence</small>
                                            </div>
                                        </div>
                                        <input type="hidden" name="kpas[5][category]" value="WORK PERFORMANCE">
                                        <input type="hidden" name="kpas[5][kpa]" value="Correspondence">
                                        <input type="hidden" name="kpas[5][result_indicators]" value="Handle incoming and outgoing correspondence, including emails, letters, and internal memos professionally">
                                    </td>
                                    <td>
                                        <div class="small">Handle incoming and outgoing correspondence, including emails, letters, and internal memos professionally</div>
                                        <div class="mt-1">
                                            <span class="badge bg-gray-100 text-gray-800 me-1">ND - 1</span>
                                            <span class="badge bg-gray-100 text-gray-800 me-1">NS - 2</span>
                                            <span class="badge bg-gray-100 text-gray-800 me-1">S - 3</span>
                                ...
                                <!-- WORK PERFORMANCE - Office Supplies -->
                                <tr>
                                    <td class="fw-medium">
                                        <div class="d-flex align-items-center">
                                            <div class="bg-purple-100 text-purple-600 p-2 rounded me-2">
                                            ...
                                            <div>
                                                WORK PERFORMANCE
                                                <small class="text-muted d-block">Office Supplies</small>
                                            </div>
                                        </div>
                                        <input type="hidden" name="kpas[6][category]" value="WORK PERFORMANCE">
                                        <input type="hidden" name="kpas[6][kpa]" value="Office Supplies">
                                        <input type="hidden" name="kpas[6][result_indicators]" value="Manage office supplies inventory and ensure timely replenishment to avoid shortages">
                                    </td>
                                    <td>
                                        <div class="small">Manage office supplies inventory and ensure timely replenishment to avoid shortages</div>
                                        <div class="mt-1">
                                            <span class="badge bg-gray-100 text-gray-800 me-1">ND - 1</span>
                                            <span class="badge bg-gray-100 text-gray-800 me-1">NS - 2</span>
                                            <span class="badge bg-gray-100 text-gray-800 me-1">S - 3</span>
                        ...
                        <div class="col-12">
                            <div class="bg-gray-50 p-4 rounded border">
                                ...
                                <div class="mb-2 d-flex justify-content-between">
                                    ...
                                    <span id="adminTotalWeight" class="fw-bold moic-navy">100%</span>
                                </div>
                                <div class="progress-moic">
                                    <div id="adminWeightProgress" class="progress-bar-moic" style="width: 100%; height: 100%;"></div>
                                </div>
                                <div id="adminWeightStatus" class="mt-2 small text-success">
    ...
    <!-- Comment Modal -->
    <div class="modal fade modal-moic" id="commentModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="modalCommentTextarea" class="form-label fw-medium">Your Comment</label>
    ...
    <script>
        ...
        const weights = [10, 25, 15, 15, 10, 10, 10, 5]; // Fixed weights for Admin Clerk
        ...
        function calculateWeightTotal() {
            const totalWeight = 100; // Fixed at 100% for Admin Clerk
            
            // Update all displays
            const weightDisplay = document.getElementById('adminTotalWeight');
            const weightStatsDisplay = document.getElementById('adminTotalWeightDisplay');
            const progressBar = document.getElementById('adminWeightProgress');
            const statusDiv = document.getElementById('adminWeightStatus');
        ...
        function saveComment() {
            ...
            // Reset current index after modal is hidden
            setTimeout(() => {
        ...
        function saveAsDraft(event) {
            ...
            document.getElementById('adminFormStatus').value = 'draft';
            ...
            document.getElementById('adminClerkForm').submit();
        }
        ...
        function submitForm(event) {
            ...
            if (confirm(confirmationMessage)) {
                document.getElementById('adminFormStatus').value = 'submitted';
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // FIX FOR ARIA-HIDDEN ISSUE: Add event listener for when modal is hidden
