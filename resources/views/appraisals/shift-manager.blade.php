...
<head>
    ...
    <title>Shift Manager Performance Appraisal - MOIC Performance Appraisal System</title>
    ...
    <style>
        /* MOIC Brand Colors - Shift Manager Theme (Leadership/Supervisory) */
        :root {
            --moic-navy: #110484;
...
<body>
            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex align-items-center desktop-only">
                        ...
                        <div>
                            <h1 class="h5 mb-0 fw-bold" style="font-size: 1rem;">Shift Manager Performance Appraisal</h1>
                            <p class="mb-0 text-white-50" style="font-size: 0.75rem;">{{ $currentQuarter }} {{ $quarterInfo->year }}</p>
                        </div>
                    </div>
                    
                    <div class="mobile-only ms-2">
                        <h1 class="h6 mb-0 fw-bold">Shift Manager</h1>
                ...
                <div class="d-flex align-items-center gap-2">
                    <div class="desktop-only text-end me-2">
                        ...
                        <div class="small text-white-50">Shift Manager</div>
                    </div>
    ...
    <main class="py-4">
        <div class="container-custom px-3">
            ...
            <!-- Main Form -->
            <form id="shiftManagerForm" action="{{ route('appraisals.store') }}" method="POST" class="card card-moic">
                @csrf
                    ...
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                        ...
                        <div class="d-flex gap-2">
                            <span class="badge bg-primary text-white" style="padding: 0.5rem 1rem;">
                                <i class="fas fa-users-cog me-1"></i> Supervisory Role
                            </span>
                            <span class="badge bg-warning text-dark" style="padding: 0.5rem 1rem;">
                                <i class="fas fa-clock me-1"></i> Shift Operations
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                            ...
                            <div class="bg-blue-50 p-3 rounded">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <p id="shiftTotalWeightDisplay" class="h4 fw-bold moic-navy mb-0">100%</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- Shift Operations Notice -->
                    <div class="shift-ops-section mb-4">
                        <div class="d-flex align-items-start gap-3">
                            <i class="fas fa-clock fa-2x mt-1"></i>
                            <div>
                                <h6 class="fw-bold mb-2">Shift Operations Management</h6>
                                <p class="small text-muted mb-0">As Shift Manager, you are responsible for overseeing all aspects of your shift including lane operations, staff management, cash handling, incident response, and reporting. Your leadership directly impacts the efficiency and effectiveness of toll collection operations.</p>
                            </div>
                        </div>
                    </div>
                                ...
                                <tr>
                                    <td class="fw-medium">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                WORK PERFORMANCE
                                                <small class="text-muted d-block">Shift Supervision</small>
                                            </div>
                                        </div>
                                    ...
                                    <td>
                                        <div class="small">Effectively supervise shift operations, ensuring all toll lanes are operational and staff are performing their duties 
...
<tr>
    <td class="fw-medium">
        <div class="d-flex align-items-center">
            ...
            <div>
                WORK PERFORMANCE
                <small class="text-muted d-block">Cash Management</small>
            </div>
        </div>
    ...
    <td>
        <div class="small">Oversee cash collection, reconciliation, and secure handling of toll revenue during shift 
        ...
        <div class="d-flex flex-column gap-2">
            ...
            <input type="hidden" name="kpas[3][comments]" id="commentInput3" value="">
                                ...
                                <tr>
                                    <td class="fw-medium">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                WORK PERFORMANCE
                                                <small class="text-muted d-block">Staff Coordination</small>
                                            </div>
                                        </div>
                                    ...
                                    <td>
                                        <div class="small">Coordinate staff breaks, rotations, and ensure adequate coverage during peak traffic hours 
                                ...
                                <tr>
                                    <td class="fw-medium">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                WORK PERFORMANCE
                                                <small class="text-muted d-block">Incident Management</small>
                                            </div>
                                        </div>
                                    ...
                                    <td>
                                        <div class="small">Handle customer complaints, equipment failures, and emergencies during shift promptly and professionally 
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="small">Complete accurate shift reports including cash collections, incidents, and staffing issues</div>
                                        <div class="mt-1">
                                            <span class="badge bg-gray-100 text-gray-800 me-1">ND - 1</span>
                                            <span class="badge bg-gray-100 text-gray-800 me-1">NS - 2</span>
                                            <span class="badge bg-gray-100 text-gray-800 me-1">S - 3</span>
                                ...
                                <tr class="bg-gray-800 text-white fw-bold">
                                    ...
                                    <td class="text-center">100%</span></td>
                                    <td class="text-center">-</span></td>
                                    <td class="text-center" id="totalScoreCell">0.00%</span></td>
                        ...
                        <div class="col-12">
                            <div class="bg-gray-50 p-4 rounded border">
                                ...
                                <div class="mb-2 d-flex justify-content-between">
                                    ...
                                    <span id="shiftTotalWeight" class="fw-bold moic-navy">100%</span>
                                </div>
                                <div class="progress-moic">
                                    <div id="shiftWeightProgress" class="progress-bar-moic" style="width: 100%; height: 100%;"></div>
                                </div>
                                <div id="shiftWeightStatus" class="mt-2 small text-success">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            <div class="bg-blue-50 p-4 rounded border">
                                ...
                                <textarea name="development_needs" rows="4" class="form-control" placeholder="List your development needs for the next period (e.g., leadership training, conflict resolution, advanced cash management, team motivation skills)..."></textarea>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="bg-green-50 p-4 rounded border">
                                ...
                                <textarea name="employee_comments" rows="4" class="form-control" placeholder="Any additional comments or feedback about your performance, challenges faced, team achievements, or suggestions for improvement..."></textarea>
                            </div>
                        </div>
                    </div>
