...
<head>
    ...
    <title>Senior Toll Collector Performance Appraisal - MOIC Performance Appraisal System</title>
    ...
    <style>
        /* MOIC Brand Colors - Senior Toll Collector Theme */
        :root {
            --moic-navy: #110484;
...
<body>
            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex align-items-center desktop-only">
                        ...
                        <div>
                            <h1 class="h5 mb-0 fw-bold" style="font-size: 1rem;">Senior Toll Collector Performance Appraisal</h1>
                            <p class="mb-0 text-white-50" style="font-size: 0.75rem;">{{ $currentQuarter }} {{ $quarterInfo->year }}</p>
                        </div>
                    </div>
                    
                    <div class="mobile-only ms-2">
                        <h1 class="h6 mb-0 fw-bold">Senior Toll Collector</h1>
                ...
                <div class="d-flex align-items-center gap-2">
                    <div class="desktop-only text-end me-2">
                        ...
                        <div class="small text-white-50">Senior Toll Collector</div>
                    </div>
    ...
    <main class="py-4">
        <div class="container-custom px-3">
            ...
            <!-- Main Form -->
            <form id="seniorTollCollectorForm" action="{{ route('appraisals.store') }}" method="POST" class="card card-moic">
                @csrf
                <input type="hidden" name="status" id="seniorTollFormStatus" value="draft">
                <input type="hidden" name="period" value="{{ $currentQuarter }}">
                <input type="hidden" name="start_date" value="{{ $startDate }}">
                <input type="hidden" name="end_date" value="{{ $endDate }}">
                <input type="hidden" name="job_title" value="Senior Toll Collector">
                ...
                <div class="card-header bg-white border-bottom bg-gray-50">
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                        ...
                        <span class="badge bg-primary text-white" style="padding: 0.5rem 1rem;">
                            <i class="fas fa-star me-1"></i> 8 Key Performance Areas
                        </span>
                    </div>
                </div>
                ...
                <div class="card-body">
                            ...
                            <div class="bg-blue-50 p-3 rounded">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <p id="seniorTollTotalWeightDisplay" class="h4 fw-bold moic-navy mb-0">100%</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- Cash Handling Notice -->
                    <div class="cash-handling-notice mb-4">
                        <div class="d-flex align-items-start gap-3">
                            <i class="fas fa-hand-holding-usd fa-2x mt-1"></i>
                            <div>
                                <h6 class="fw-bold mb-2">Cash Handling & Revenue Integrity</h6>
                                <p class="small text-muted mb-0">Accuracy in cash handling is critical. Any discrepancies must be reported immediately. Regular cash counts and reconciliation are mandatory. Senior collectors are responsible for ensuring proper cash handling procedures are followed by all team members.</p>
                            </div>
                        </div>
                    </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="fw-medium">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                WORK PERFORMANCE
                                                <small class="text-muted d-block">Team Support</small>
                                            </div>
                                        </div>
                                        <input type="hidden" name="kpas[5][category]" value="WORK PERFORMANCE">
                                        <input type="hidden" name="kpas[5][kpa]" value="Team Support">
                                        <input type="hidden" name="kpas[5][result_indicators]" value="Provide guidance and support to junior toll collectors and assist in their training">
                                    </td>
                                    <td>
                                        <div class="small">Provide guidance and support to junior toll collectors and assist in their training 
                                            <span class="critical-badge">SENIOR ROLE</span>
                                        </div>
                                        <div class="mt-1">
                                            <span class="badge bg-gray-100 text-gray-800 me-1">ND - 1</span>
                                            <span class="badge bg-gray-100 text-gray-800 me-1">NS - 2</span>
                                ...
                                <tr>
                                    <td class="fw-medium">
                                        ...
                                        <input type="hidden" name="kpas[6][kpa]" value="Lane Management">
                                        <input type="hidden" name="kpas[6][result_indicators]" value="Maintain lane cleanliness and operational readiness, report any equipment issues promptly">
                                    </td>
                                    <td>
                        ...
                        <div class="col-12">
                            <div class="bg-gray-50 p-4 rounded border">
                                ...
                                <div class="mb-2 d-flex justify-content-between">
                                    ...
                                    <span id="seniorTollTotalWeight" class="fw-bold moic-navy">100%</span>
                                </div>
                                <div class="progress-moic">
                                    <div id="seniorTollWeightProgress" class="progress-bar-moic" style="width: 100%; height: 100%;"></div>
                                </div>
                                <div id="seniorTollWeightStatus" class="mt-2 small text-success">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            <div class="bg-blue-50 p-4 rounded border">
                                ...
                                <textarea name="development_needs" rows="4" class="form-control" placeholder="List your development needs for the next period (e.g., leadership training, advanced customer service skills, cash handling certification, conflict resolution)..."></textarea>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="bg-green-50 p-4 rounded border">
                                ...
                                <textarea name="employee_comments" rows="4" class="form-control" placeholder="Any additional comments or feedback about your performance, challenges faced, team mentoring experiences, or suggestions for improvement..."></textarea>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        const weights = [10, 25, 20, 15, 10, 10, 5, 5]; // Fixed weights for Senior Toll Collector
        ...
        function calculateWeightTotal() {
            const totalWeight = 100; // Fixed at 100% for Senior Toll Collector
            
            // Update all displays
            const weightDisplay = document.getElementById('seniorTollTotalWeight');
            const weightStatsDisplay = document.getElementById('seniorTollTotalWeightDisplay');
            const progressBar = document.getElementById('seniorTollWeightProgress');
            const statusDiv = document.getElementById('seniorTollWeightStatus');
        ...
        function saveAsDraft(event) {
            ...
            document.getElementById('seniorTollFormStatus').value = 'draft';
            ...
            setTimeout(() => {
                document.getElementById('seniorTollCollectorForm').submit();
            }, 1500);
        }
        ...
        function submitForm(event) {
            ...
            if (confirm(confirmationMessage)) {
                document.getElementById('seniorTollFormStatus').value = 'submitted';
