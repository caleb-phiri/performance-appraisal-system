...
<head>
    ...
    <title>Trainer Performance Appraisal - MOIC</title>
...
<body class="bg-gray-50">
    ...
    <div class="max-w-7xl mx-auto py-6 px-4">
        <!-- Header -->
        <div class="bg-gradient-to-r from-green-800 to-teal-700 rounded-xl shadow-lg mb-6">
            <div class="p-6">
                <div class="flex justify-between items-center">
                    <div>
                        <h1 class="text-2xl font-bold text-white">Trainer Performance Appraisal</h1>
                        <p class="text-green-100 mt-1">{{ $quarter }} {{ $year }}</p>
                    </div>
                    <a href="{{ route('appraisals.create') }}" class="bg-white text-green-800 px-4 py-2 rounded-lg hover:bg-green-50">
        ...
        <form id="appraisalForm" method="POST" action="{{ route('appraisals.store') }}">
            ...
            <input type="hidden" name="job_title" value="Trainer">
                        ...
                        <tbody>
                            ...
                            <tr class="border-b hover:bg-gray-50">
                                <td class="p-3 font-semibold">
                                    {{ $title }}
                                    <input type="hidden" name="kpas[{{ $index }}][category]" value="TRAINING & DEVELOPMENT">
            ...
            <div class="bg-white rounded-xl shadow-md p-6 flex justify-between items-center">
                <div class="text-sm text-gray-500">
                    ...
                    Rate each KPA based on training effectiveness, participant feedback, and learning outcomes
                </div>
                <div class="flex gap-3">
                    <button type="button" onclick="saveDraft()" class="bg-yellow-500 hover:bg-yellow-600 text-white px-6 py-2 rounded-lg">
                        <i class="fas fa-save mr-2"></i> Save Draft
                    </button>
                    <button type="button" onclick="submitForm()" class="bg-green-600 hover:bg-green-700 text-white px-6 py-2 rounded-lg">
