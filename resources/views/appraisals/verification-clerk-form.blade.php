...
<head>
    ...
    <title>Verification Clerk Performance Appraisal - MOIC Performance Appraisal System</title>
    ...
    <style>
        /* MOIC Brand Colors - Verification Clerk Theme (Audit/Compliance) */
        :root {
            --moic-navy: #110484;
        ...
        .audit-color { color: var(--audit) !important; }
        .audit-bg { background-color: var(--audit-light) !important; }
...
<body>
            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex align-items-center desktop-only">
                        ...
                        <div>
                            <h1 class="h5 mb-0 fw-bold" style="font-size: 1rem;">Verification Clerk Performance Appraisal</h1>
                            <p class="mb-0 text-white-50" style="font-size: 0.75rem;">{{ $currentQuarter }} {{ $quarterInfo->year }}</p>
                        </div>
                    </div>
                    
                    <div class="mobile-only ms-2">
                        <h1 class="h6 mb-0 fw-bold">Verification Clerk</h1>
                ...
                <div class="d-flex align-items-center gap-2">
                    <div class="desktop-only text-end me-2">
                        ...
                        <div class="small text-white-50">Verification Clerk</div>
                    </div>
        ...
        <div class="container-custom px-3 py-2">
            <div class="d-flex flex-wrap gap-2 justify-content-between align-items-center">
                <div class="d-flex flex-wrap gap-2">
                    ...
                    <a href="{{ route('appraisals.create') }}" class="btn btn-outline-moic btn-sm">
    ...
    <main class="py-4">
        <div class="container-custom px-3">
                    ...
                    <div class="stat-card">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p class="fw-semibold mb-0">Audit Team Leader</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- Main Form -->
            <form id="verificationClerkForm" action="{{ route('appraisals.store') }}" method="POST" class="card card-moic">
                @csrf
                <input type="hidden" name="status" id="verificationFormStatus" value="draft">
                <input type="hidden" name="period" value="{{ $currentQuarter }}">
                <input type="hidden" name="start_date" value="{{ $startDate }}">
                <input type="hidden" name="end_date" value="{{ $endDate }}">
                <input type="hidden" name="job_title" value="Verification Clerk">
...
<div class="table-responsive mb-4">
    <table class="table table-moic mb-0">
        ...
        <tbody>
            ...
            <!-- WORK PERFORMANCE - Audit Frequency - KPA 3 -->
            <tr>
                <td class="fw-medium">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            WORK PERFORMANCE
                            <small class="text-muted d-block">Audit Frequency</small>
                        </div>
                    </div>
                    <input type="hidden" name="kpas[2][category]" value="WORK PERFORMANCE">
                    <input type="hidden" name="kpas[2][kpa]" value="Audit Frequency">
                    <input type="hidden" name="kpas[2][result_indicators]" value="Complete scheduled transaction audits for assigned toll plazas in accordance with company-prescribed daily, weekly, bi-weekly, and monthly audit schedules">
                </td>
                <td>
                    <div class="small">Complete scheduled transaction audits for assigned toll plazas in accordance with company-prescribed daily, weekly, bi-weekly, and monthly audit schedules 
                        <span class="audit-badge">AUDIT</span>
                        <span class="deadline-badge">DEADLINE</span>
                    </div>
                    <div class="mt-1">
                ...
                <td class="weight-cell">
                    <span class="weight-display">20%</span>
                    <input type="hidden" name="kpas[2][weight]" value="20">
                </td>
                <td>
            ...
            <!-- WORK PERFORMANCE - Audit Accuracy - KPA 4 -->
            <tr>
                <td class="fw-medium">
                    <div class="d-flex align-items-center">
                        <div class="bg-purple-100 text-purple-600 p-2 rounded me-2">
                        ...
                        <div>
                            WORK PERFORMANCE
                            <small class="text-muted d-block">Audit Accuracy</small>
                        </div>
                    </div>
                    <input type="hidden" name="kpas[3][category]" value="WORK PERFORMANCE">
                    <input type="hidden" name="kpas[3][kpa]" value="Audit Accuracy">
                    <input type="hidden" name="kpas[3][result_indicators]" value="Maintain ≥98% audit accuracy, with findings supported by verifiable transaction records and system data">
                </td>
                <td>
                    <div class="small">Maintain ≥98% audit accuracy, with findings supported by verifiable transaction records and system data 
                        <span class="accuracy-badge">≥98% ACCURACY</span>
                        <span class="audit-badge">EVIDENCE</span>
                    </div>
                    <div class="mt-1">
                        <span class="badge bg-gray-100 text-gray-800 me-1">ND - 1</span>
                        <span class="badge bg-gray-100 text-gray-800 me-1">NS - 2</span>
                ...
                <td class="weight-cell">
                    <span class="weight-display">20%</span>
                    <input type="hidden" name="kpas[3][weight]" value="20">
                </td>
                <td>
            ...
            <!-- WORK PERFORMANCE - Transaction Correction Follow-up - KPA 5 -->
            <tr>
                <td class="fw-medium">
                    <div class="d-flex align-items-center">
                        <div class="bg-purple-100 text-purple-600 p-2 rounded me-2">
                        ...
                        <div>
                            WORK PERFORMANCE
                            <small class="text-muted d-block">Correction Follow-up</small>
                        </div>
                    </div>
                    <input type="hidden" name="kpas[4][category]" value="WORK PERFORMANCE">
                    <input type="hidden" name="kpas[4][kpa]" value="Transaction Correction Follow-up">
                    <input type="hidden" name="kpas[4][result_indicators]" value="Ensure abnormal transactions are corrected by the toll plaza within three (3) working days and re-verified in the system">
                </td>
                <td>
                    <div class="small">Ensure abnormal transactions are corrected by the toll plaza within three (3) working days and re-verified in the system 
                        <span class="deadline-badge">3-DAY SLA</span>
                    </div>
                    <div class="mt-1">
                        <span class="badge bg-gray-100 text-gray-800 me-1">ND - 1</span>
                        <span class="badge bg-gray-100 text-gray-800 me-1">NS - 2</span>
                ...
                <td class="weight-cell">
                    ...
                    <input type="hidden" name="kpas[4][weight]" value="15">
                </td>
                <td>
            ...
            <!-- WORK PERFORMANCE - Audit Reporting - KPA 6 -->
            <tr>
                <td class="fw-medium">
                    <div class="d-flex align-items-center">
                        <div class="bg-purple-100 text-purple-600 p-2 rounded me-2">
                        ...
                        <div>
                            WORK PERFORMANCE
                            <small class="text-muted d-block">Audit Reporting</small>
                        </div>
                    </div>
                    <input type="hidden" name="kpas[5][category]" value="WORK PERFORMANCE">
                    <input type="hidden" name="kpas[5][kpa]" value="Audit Reporting">
                    <input type="hidden" name="kpas[5][result_indicators]" value="Report audit results to the supervisor using the company-prescribed template within one working day of completing the audit">
                </td>
                <td>
                    <div class="small">Report audit results to the supervisor using the company-prescribed template within one working day of completing the audit 
                        <span class="deadline-badge">24HR DEADLINE</span>
                    </div>
                    <div class="mt-1">
                        <span class="badge bg-gray-100 text-gray-800 me-1">ND - 1</span>
                        <span class="badge bg-gray-100 text-gray-800 me-1">NS - 2</span>
                ...
                <td class="weight-cell">
                    ...
                    <input type="hidden" name="kpas[5][weight]" value="5">
                </td>
                <td>
            ...
            <tr>
                <td class="fw-medium">
                    ...
                    <input type="hidden" name="kpas[6][category]" value="ATTITUDE">
                    <input type="hidden" name="kpas[6][kpa]" value="Attitude">
                    <input type="hidden" name="kpas[6][result_indicators]" value="Exhibit a proactive attitude, take initiative in tasks, and foster positive interactions with colleagues">
                </td>
                <td>
            ...
            <tr class="bg-gray-800 text-white fw-bold">
                ...
                <td class="text-center"><i class="fas fa-chart-line"></i></td>
                    ...
                    <div class="bg-light p-4 rounded border mb-4">
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="employee_name" class="form-control" value="{{ Auth::user()->name ?? '' }}" placeholder="Enter your full name" required>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="radio" name="agreement_option" id="agreeOption" value="agree" required>
                                <label class="form-check-label" for="agreeOption">
                                    a. I am in agreement with the results of my performance review
                                </label>
                            </div>
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="radio" name="agreement_option" id="notAgreeOption" value="not_agree">
                        ...
                        <div id="managerReasonSection" class="mb-3 d-none">
                            <label class="form-label fw-medium">Manager's Reason (if option b selected):</label>
                            <textarea name="manager_reason" rows="2" class="form-control" placeholder="Please provide reason for disagreement..."></textarea>
                        </div>
                    </div>
                    ...
                    <div class="alert alert-info mb-4" role="alert">
                        ...
                        <strong>Audit Completion Reminder:</strong> Ensure all audit findings are properly documented with supporting evidence. Follow up on any outstanding corrections and verify they have been completed in the system.
                    </div>
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            <div class="bg-blue-50 p-4 rounded border">
                                ...
                                <textarea name="development_needs" rows="4" class="form-control" placeholder="What skills, abilities and/or knowledge do you need to develop in order to improve your performance in present job, to achieve job goals or to prepare for promotion? (e.g., advanced Excel, audit software proficiency, data analysis skills, communication skills)..."></textarea>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="bg-green-50 p-4 rounded border">
                                ...
                                <textarea name="career_aspirations" rows="4" class="form-control" placeholder="Record your career aspirations and potential for promotion in the short/medium/long term. (e.g., Senior Verification Clerk, Audit Team Leader, Internal Auditor)..."></textarea>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="d-flex flex-wrap justify-content-lg-end gap-4">
                        ...
                        <span class="text-muted small">
                            <i class="fas fa-clipboard-check me-1 moic-accent"></i> Reporting Line: Audit Team Leader
                        </span>
                    </div>
                </div>
            </div>
  ...
  <script>
    ...
    const kpaTitles = [
        ...
        "WORK PERFORMANCE - Audit Frequency",
        "WORK PERFORMANCE - Audit Accuracy",
        "WORK PERFORMANCE - Correction Follow-up",
        "WORK PERFORMANCE - Audit Reporting",
        "ATTITUDE - Attitude"
    ];
    
    // Fixed weights for Verification Clerk - based on the template (10+25+20+20+15+5+5 = 100)
    const weights = [10, 25, 20, 20, 15, 5, 5];
    const TOTAL_EXPECTED_WEIGHT = 100;
    ...
    function calculateWeightTotal() {
        // Use the fixed weights array as the single source of truth
        let totalWeight = weights.reduce((sum, weight) => sum + weight, 0);
        
        // Update all displays
        const weightDisplay = document.getElementById('verificationTotalWeight');
        const weightStatsDisplay = document.getElementById('verificationTotalWeightDisplay');
        const progressBar = document.getElementById('verificationWeightProgress');
        const statusDiv = document.getElementById('verificationWeightStatus');
        ...
        // Update status message - always show success since weights are fixed
        if (statusDiv) {
    ...
    function openCommentModal(index) {
        ...
        // Initialize modal if not already initialized or if it was disposed
        if (!commentModal) {
        ...
        // Remove error class from char count
        if (charCount) charCount.classList.remove('text-danger');
    ...
    function saveComment() {
        if (currentCommentIndex === -1) {
            console.error('No comment index selected');
            return;
        }
        ...
        if (commentInput) {
            ...
            console.log(`Saved comment for index ${currentCommentIndex}: ${comment}`);
        } else {
            console.error(`Comment input not found for index ${currentCommentIndex}`);
        }
        ...
        if (commentPreview) {
            if (comment) {
                ...
                // Add a visual indicator that comment exists
                commentPreview.style.borderLeft = '3px solid var(--moic-navy)';
                commentPreview.style.paddingLeft = '0.5rem';
            } else {
                commentPreview.textContent = 'No comment added';
                commentPreview.className = 'comment-preview text-muted';
                commentPreview.style.borderLeft = '';
                commentPreview.style.paddingLeft = '';
            }
        } else {
            console.error(`Comment preview not found for index ${currentCommentIndex}`);
        }
    ...
    function validateForm() {
        ...
        // Check if agreement option is selected
    ...
    function saveAsDraft(event) {
        ...
        document.getElementById('verificationFormStatus').value = 'draft';
        ...
        setTimeout(() => {
            document.getElementById('verificationClerkForm').submit();
        }, 1500);
    }
    ...
    function submitForm(event) {
        ...
        // Confirm submission with grace period notice if applicable
        ...
        if (confirm(confirmMessage)) {
            document.getElementById('verificationFormStatus').value = 'submitted';
    ...
    function initAgreementHandler() {
        const agreeOption = document.getElementById('agreeOption');
        const notAgreeOption = document.getElementById('notAgreeOption');
        const managerReasonSection = document.getElementById('managerReasonSection');
        
        if (agreeOption && notAgreeOption && managerReasonSection) {
            agreeOption.addEventListener('change', function() {
                if (this.checked) {
                    managerReasonSection.classList.add('d-none');
                }
            });
            
            notAgreeOption.addEventListener('change', function() {
                if (this.checked) {
                    managerReasonSection.classList.remove('d-none');
                }
            });
        }
    }
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Initialize comment previews and load existing comments
        for (let i = 0; i < 7; i++) {
            ...
            if (commentPreview) {
                if (commentInput && commentInput.value && commentInput.value.trim() !== '') {
                    ...
                    commentPreview.style.borderLeft = '3px solid var(--moic-navy)';
                    commentPreview.style.paddingLeft = '0.5rem';
                    console.log(`Loaded comment for KPA ${i}: ${commentInput.value}`);
                } else {
                    commentPreview.textContent = 'No comment added';
                    commentPreview.className = 'comment-preview text-muted';
                    commentPreview.style.borderLeft = '';
        ...
        // Add keyboard shortcut for Ctrl+Enter to save comment
        const modalCommentTextarea = document.getElementById('modalCommentTextarea');
        if (modalCommentTextarea) {
            modalCommentTextarea.addEventListener('keydown', function(e) {
    ...
    document.addEventListener('keydown', function(e) {
        ...
        // Ctrl + S to save as draft (only if not typing)
        if (e.ctrlKey && e.key === 's' && !isTyping) {
            e.preventDefault();
            const saveButton = document.querySelector('button[onclick="saveAsDraft(event)"]');
            if (saveButton) saveAsDraft(e);
        }
        
        // Ctrl + Enter to submit (only if not typing)
        if (e.ctrlKey && e.key === 'Enter' && !isTyping) {
            e.preventDefault();
            const submitButton = document.querySelector('button[onclick="submitForm(event)"]');
            if (submitButton) submitForm(e);
        }
    });
</script>
</body>
