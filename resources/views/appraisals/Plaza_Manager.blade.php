...
<head>
    ...
    <title>Plaza Manager Performance Appraisal - MOIC Performance Appraisal System</title>
...
<body>
            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex align-items-center desktop-only">
                        ...
                        <div>
                            <h1 class="h5 mb-0 fw-bold" style="font-size: 1rem;">Plaza Manager Performance Appraisal</h1>
                            <p class="mb-0 text-white-50" style="font-size: 0.75rem;">{{ $currentQuarter }} {{ $quarterInfo->year }}</p>
                        </div>
                    </div>
                    
                    <div class="mobile-only ms-2">
                        <h1 class="h6 mb-0 fw-bold">Plaza Manager</h1>
                ...
                <div class="d-flex align-items-center gap-2">
                    <div class="desktop-only text-end me-2">
                        ...
                        <div class="small text-white-50">Plaza Manager</div>
                    </div>
    ...
    <main class="py-4">
        <div class="container-custom px-3">
                    ...
                    <div class="stat-card">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p class="fw-semibold mb-0">Operation Manager</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- Main Form -->
            <form id="plazaManagerForm" action="{{ route('appraisals.store') }}" method="POST" class="card card-moic">
                @csrf
                ...
                <div class="card-header bg-white border-bottom bg-gray-50">
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                        ...
                        <span class="badge bg-primary text-white" style="padding: 0.5rem 1rem;">
                            <i class="fas fa-star me-1"></i> 12 Key Performance Areas
                        </span>
                    </div>
                </div>
                            ...
                            <div class="bg-blue-50 p-3 rounded">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <p id="plazaTotalWeightDisplay" class="h4 fw-bold moic-navy mb-0">100%</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="bg-green-50 p-3 rounded">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="h4 fw-bold text-success mb-0">12</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <table class="table table-moic mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="fw-medium">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                WORK PERFORMANCE
                                                <small class="text-muted d-block">Revenue Deposit</small>
                                            </div>
                                        </div>
                                    ...
                                    <td>
                                        <div class="small">Complete the deposit of toll revenue into the bank and verify the accounting records to ensure the security of cash income 
                                ...
                                <tr>
                                    <td class="fw-medium">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                WORK PERFORMANCE
                                                <small class="text-muted d-block">Staff Management</small>
                                            </div>
                                        </div>
                                    ...
                                    <td>
                                        <div class="small">Manage staff, including recruitment, training, meeting, dismissal, dress code, shift scheduling and disciplinary actions to ensure adequate staffing and team stability</div>
                                        <div class="mt-1">
                                            <span class="badge bg-gray-100 text-gray-800 me-1">ND - 1</span>
                                            <span class="badge bg-gray-100 text-gray-800 me-1">NS - 2</span>
                                            <span class="badge bg-gray-100 text-gray-800 me-1">S - 3</span>
                                ...
                                <tr>
                                    <td class="fw-medium">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                WORK PERFORMANCE
                                                <small class="text-muted d-block">Income Monitoring</small>
                                            </div>
                                        </div>
                                    ...
                                    <td>
                                        <div class="small">Monitor toll income, conduct regular transaction audits and corrections, manage float supply, and handle/report anomalies to ensure accuracy and compliance</div>
                                        <div class="mt-1">
                                            <span class="badge bg-gray-100 text-gray-800 me-1">ND - 1</span>
                                            <span class="badge bg-gray-100 text-gray-800 me-1">NS - 2</span>
                                            <span class="badge bg-gray-100 text-gray-800 me-1">S - 3</span>
                                ...
                                <tr>
                                    <td class="fw-medium">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                WORK PERFORMANCE
                                                <small class="text-muted d-block">Traffic Monitoring</small>
                                            </div>
                                        </div>
                                    ...
                                    <td>
                                        <div class="small">Monitor lane traffic, respond to any queue length, and ensure average servicing time and vehicle queues meet company benchmarks to maintain traffic flow and efficiency</div>
                                        <div class="mt-1">
                                            <span class="badge bg-gray-100 text-gray-800 me-1">ND - 1</span>
                                            <span class="badge bg-gray-100 text-gray-800 me-1">NS - 2</span>
                                            <span class="badge bg-gray-100 text-gray-800 me-1">S - 3</span>
                                ...
                                <tr>
                                    <td class="fw-medium">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                WORK PERFORMANCE
                                                <small class="text-muted d-block">Operations Audit</small>
                                            </div>
                                        </div>
                                    ...
                                    <td>
                                        <div class="small">Ensure operation teams operate efficiently and regularly audit shift documentations for compliance and performance</div>
                                        <div class="mt-1">
                                            <span class="badge bg-gray-100 text-gray-800 me-1">ND - 1</span>
                                            <span class="badge bg-gray-100 text-gray-800 me-1">NS - 2</span>
                                            <span class="badge bg-gray-100 text-gray-800 me-1">S - 3</span>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="small">Submit financial and operational reports on time as per company requirements</div>
                                        <div class="mt-1">
                                            <span class="badge bg-gray-100 text-gray-800 me-1">ND - 1</span>
                                            <span class="badge bg-gray-100 text-gray-800 me-1">NS - 2</span>
                                            <span class="badge bg-gray-100 text-gray-800 me-1">S - 3</span>
                                ...
                                <tr>
                                    <td class="fw-medium">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                WORK PERFORMANCE
                                                <small class="text-muted d-block">Team Management</small>
                                            </div>
                                        </div>
                                    ...
                                    <td>
                                        <div class="small">Manage the Maintenance and Admin Team to ensure toll equipment remains in optimal working condition and daily administrative operations are organized and efficient</div>
                                        <div class="mt-1">
                                            <span class="badge bg-gray-100 text-gray-800 me-1">ND - 1</span>
                                            <span class="badge bg-gray-100 text-gray-800 me-1">NS - 2</span>
                                            <span class="badge bg-gray-100 text-gray-800 me-1">S - 3</span>
                                    ...
                                    <td>
                                        <span id="scoreCell8" class="fw-bold">0%</span>
                                ...
                                <tr>
                                    <td class="fw-medium">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                WORK PERFORMANCE
                                                <small class="text-muted d-block">Safety Management</small>
                                            </div>
                                        </div>
                                    ...
                                    <td>
                                        <div class="small">Identify and mitigate safety risks, supervise security guard patrols and access control to ensure a safe working environment</div>
                                        <div class="mt-1">
                                            <span class="badge bg-gray-100 text-gray-800 me-1">ND - 1</span>
                                            <span class="badge bg-gray-100 text-gray-800 me-1">NS - 2</span>
                                            <span class="badge bg-gray-100 text-gray-800 me-1">S - 3</span>
                                    ...
                                    <td class="weight-cell">
                                        <span class="weight-display">3%</span>
                                    ...
                                    <td>
                                        <span id="scoreCell9" class="fw-bold">0%</span>
                                ...
                                <tr>
                                    <td class="fw-medium">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                WORK PERFORMANCE
                                                <small class="text-muted d-block">External Relations</small>
                                            </div>
                                        </div>
                                    ...
                                    <td>
                                        <div class="small">Handle visits, complaints, and collaboration from media and authorities, maintain a professional image, and foster positive external relationships</div>
                                        <div class="mt-1">
                                            <span class="badge bg-gray-100 text-gray-800 me-1">ND - 1</span>
                                            <span class="badge bg-gray-100 text-gray-800 me-1">NS - 2</span>
                                            <span class="badge bg-gray-100 text-gray-800 me-1">S - 3</span>
                                    ...
                                    <td class="weight-cell">
                                        <span class="weight-display">2%</span>
                                        <input type="hidden" name="kpas[10][weight]" value="2">
                                    </td>
                                    <td>
                                        <select name="kpas[10][self_rating]" required class="rating-select" id="rating10">
                                            <option value="">Select Rating</option>
                                            <option value="1">1 - ND (Not Demonstrated)</option>
                                            <option value="2">2 - NS (Not Satisfactory)</option>
                                            <option value="3">3 - S (Satisfactory)</option>
                                    ...
                                    <td>
                                        <span id="scoreCell10" class="fw-bold">0%</span>
                                        <input type="hidden" name="kpas[10][calculated_score]" id="calculatedScore10" value="0">
                                    </td>
                                    <td>
                                        <div class="d-flex flex-column gap-2">
                                            <div id="commentPreview10" class="comment-preview">No comment added</div>
                                            <button type="button" onclick="openCommentModal(10)" class="btn btn-sm btn-outline-moic">
                                                <i class="fas fa-edit me-1"></i>Add Comment
                                            </button>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="kpas[11][self_rating]" required class="rating-select" id="rating11">
                                            <option value="">Select Rating</option>
                                            <option value="1">1 - ND (Not Demonstrated)</option>
                                            <option value="2">2 - NS (Not Satisfactory)</option>
                                            <option value="3">3 - S (Satisfactory)</option>
                                    ...
                                    <td>
                                        <span id="scoreCell11" class="fw-bold">0%</span>
                                        <input type="hidden" name="kpas[11][calculated_score]" id="calculatedScore11" value="0">
                                    </td>
                                    <td>
                                        <div class="d-flex flex-column gap-2">
                                            <div id="commentPreview11" class="comment-preview">No comment added</div>
                                            <button type="button" onclick="openCommentModal(11)" class="btn btn-sm btn-outline-moic">
                                                <i class="fas fa-edit me-1"></i>Add Comment
                                            </button>
                        ...
                        <div class="col-12">
                            <div class="bg-gray-50 p-4 rounded border">
                                ...
                                <div class="mb-2 d-flex justify-content-between">
                                    ...
                                    <span id="plazaTotalWeight" class="fw-bold moic-navy">100%</span>
                                </div>
                                <div class="progress-moic">
                                    <div id="plazaWeightProgress" class="progress-bar-moic" style="width: 100%; height: 100%;"></div>
                                </div>
                                <div id="plazaWeightStatus" class="mt-2 small text-success">
