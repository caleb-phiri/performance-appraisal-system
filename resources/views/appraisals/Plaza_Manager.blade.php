...
<head>
    ...
    <title>Plaza Manager Performance Appraisal - MOIC</title>
...
<body class="min-h-screen bg-gray-50">
                ...
                <div class="flex justify-between items-start">
                    <div class="flex-1">
                        <div class="flex items-center mb-3">
                            ...
                            <div>
                                <h1 class="text-2xl font-bold mb-1">Plaza Manager - Performance Appraisal</h1>
                        ...
                        <div class="flex flex-wrap gap-4 mt-4">
                            ...
                            <div class="bg-white/10 backdrop-blur-sm rounded-lg px-3 py-2">
                                ...
                                <p class="font-semibold text-white">Operation Manager</p>
                            </div>
                        </div>
                    </div>
    ...
    <main class="max-w-7xl mx-auto">
        <form id="plazaManagerForm" action="{{ route('appraisals.store') }}" method="POST" class="bg-white rounded-lg shadow-lg p-6 border border-gray-200">
            @csrf
            <input type="hidden" name="status" id="plazaFormStatus" value="draft">
            <input type="hidden" name="period" value="{{ $quarterInfo->quarter }}">
            <input type="hidden" name="start_date" value="{{ $startDate }}">
            <input type="hidden" name="end_date" value="{{ $endDate }}">
            <input type="hidden" name="job_title" value="Plaza Manager">
            ...
            <div class="flex justify-between items-center mb-6 pb-4 border-b border-gray-200">
                ...
                <span class="bg-gradient-to-r from-[#110484] to-[#1a0c9e] text-white px-3 py-1 rounded-full text-sm font-semibold">
                    <i class="fas fa-star mr-1"></i> 12 Key Performance Areas
                </span>
            </div>
                ...
                <div class="bg-gradient-to-r from-green-50 to-emerald-50 border border-emerald-100 rounded-lg p-4">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p id="plazaTotalWeightDisplay" class="text-lg font-bold text-gray-800">100%</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-r from-purple-50 to-violet-50 border border-purple-100 rounded-lg p-4">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-lg font-bold text-gray-800">12 KPAs</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="overflow-x-auto rounded-lg border border-gray-200 mb-8">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <!-- WORK PERFORMANCE - Revenue Deposit -->
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <span class="text-xs text-gray-500">Revenue Deposit</span>
                                    </div>
                                </div>
                                <input type="hidden" name="kpas[2][category]" value="WORK PERFORMANCE">
                                <input type="hidden" name="kpas[2][kpa]" value="Revenue Deposit">
                                <input type="hidden" name="kpas[2][result_indicators]" value="Complete the deposit of toll revenue into the bank and verify the accounting records to ensure the security of cash income">
                            </td>
                            <td class="px-6 py-4">
                                <div class="text-sm text-gray-900 font-medium">Complete the deposit of toll revenue into the bank and verify the accounting records to ensure the security of cash income 
                        ...
                        <!-- WORK PERFORMANCE - Staff Management -->
                        <tr class="kpa-row hover:bg-purple-50/50 transition duration-150">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="bg-purple-100 text-purple-600 p-2 rounded mr-3">
                                    ...
                                    <div>
                                        <span class="font-semibold text-gray-900">WORK PERFORMANCE</span><br>
                                        <span class="text-xs text-gray-500">Staff Management</span>
                                    </div>
                                </div>
                                <input type="hidden" name="kpas[3][category]" value="WORK PERFORMANCE">
                                <input type="hidden" name="kpas[3][kpa]" value="Staff Management">
                                <input type="hidden" name="kpas[3][result_indicators]" value="Manage staff, including recruitment, training, meeting, dismissal, dress code, shift scheduling and disciplinary actions to ensure adequate staffing and team stability">
                            </td>
                            <td class="px-6 py-4">
                                <div class="text-sm text-gray-900 font-medium">Manage staff, including recruitment, training, meeting, dismissal, dress code, shift scheduling and disciplinary actions to ensure adequate staffing and team stability</div>
                                <div class="text-xs text-gray-500 mt-1">
                                    <span class="inline-block px-2 py-1 bg-gray-100 rounded">ND - 1 point</span>
                                    <span class="inline-block px-2 py-1 bg-gray-100 rounded">NS - 2 points</span>
                                    <span class="inline-block px-2 py-1 bg-gray-100 rounded">S - 3 points</span>
                        ...
                        <!-- WORK PERFORMANCE - Income Monitoring -->
                        <tr class="kpa-row hover:bg-purple-50/50 transition duration-150">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="bg-purple-100 text-purple-600 p-2 rounded mr-3">
                                    ...
                                    <div>
                                        <span class="font-semibold text-gray-900">WORK PERFORMANCE</span><br>
                                        <span class="text-xs text-gray-500">Income Monitoring</span>
                                    </div>
                                </div>
                                <input type="hidden" name="kpas[4][category]" value="WORK PERFORMANCE">
                                <input type="hidden" name="kpas[4][kpa]" value="Income Monitoring">
                                <input type="hidden" name="kpas[4][result_indicators]" value="Monitor toll income, conduct regular transaction audits and corrections, manage float supply, and handle/report anomalies to ensure accuracy and compliance">
                            </td>
                            <td class="px-6 py-4">
                                <div class="text-sm text-gray-900 font-medium">Monitor toll income, conduct regular transaction audits and corrections, manage float supply, and handle/report anomalies to ensure accuracy and compliance</div>
                                <div class="text-xs text-gray-500 mt-1">
                                    <span class="inline-block px-2 py-1 bg-gray-100 rounded">ND - 1 point</span>
                                    <span class="inline-block px-2 py-1 bg-gray-100 rounded">NS - 2 points</span>
                                    <span class="inline-block px-2 py-1 bg-gray-100 rounded">S - 3 points</span>
                        ...
                        <!-- WORK PERFORMANCE - Traffic Monitoring -->
                        <tr class="kpa-row hover:bg-purple-50/50 transition duration-150">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="bg-purple-100 text-purple-600 p-2 rounded mr-3">
                                    ...
                                    <div>
                                        <span class="font-semibold text-gray-900">WORK PERFORMANCE</span><br>
                                        <span class="text-xs text-gray-500">Traffic Monitoring</span>
                                    </div>
                                </div>
                                <input type="hidden" name="kpas[5][category]" value="WORK PERFORMANCE">
                                <input type="hidden" name="kpas[5][kpa]" value="Traffic Monitoring">
                                <input type="hidden" name="kpas[5][result_indicators]" value="Monitor lane traffic, respond to any queue length, and ensure average servicing time and vehicle queues meet company benchmarks to maintain traffic flow and efficiency">
                            </td>
                            <td class="px-6 py-4">
                                <div class="text-sm text-gray-900 font-medium">Monitor lane traffic, respond to any queue length, and ensure average servicing time and vehicle queues meet company benchmarks to maintain traffic flow and efficiency</div>
                                <div class="text-xs text-gray-500 mt-1">
                                    <span class="inline-block px-2 py-1 bg-gray-100 rounded">ND - 1 point</span>
                                    <span class="inline-block px-2 py-1 bg-gray-100 rounded">NS - 2 points</span>
                                    <span class="inline-block px-2 py-1 bg-gray-100 rounded">S - 3 points</span>
                        ...
                        <!-- WORK PERFORMANCE - Operations Audit -->
                        <tr class="kpa-row hover:bg-purple-50/50 transition duration-150">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="bg-purple-100 text-purple-600 p-2 rounded mr-3">
                                    ...
                                    <div>
                                        <span class="font-semibold text-gray-900">WORK PERFORMANCE</span><br>
                                        <span class="text-xs text-gray-500">Operations Audit</span>
                                    </div>
                                </div>
                                <input type="hidden" name="kpas[6][category]" value="WORK PERFORMANCE">
                                <input type="hidden" name="kpas[6][kpa]" value="Operations Audit">
                                <input type="hidden" name="kpas[6][result_indicators]" value="Ensure operation teams operate efficiently and regularly audit shift documentations for compliance and performance">
                            </td>
                            <td class="px-6 py-4">
                                <div class="text-sm text-gray-900 font-medium">Ensure operation teams operate efficiently and regularly audit shift documentations for compliance and performance</div>
                                <div class="text-xs text-gray-500 mt-1">
                                    <span class="inline-block px-2 py-1 bg-gray-100 rounded">ND - 1 point</span>
                                    <span class="inline-block px-2 py-1 bg-gray-100 rounded">NS - 2 points</span>
                                    <span class="inline-block px-2 py-1 bg-gray-100 rounded">S - 3 points</span>
                            ...
                            <td class="px-6 py-4 weight-cell">
                                <div class="relative">
                                    <input type="hidden" name="kpas[6][weight]" value="5">
                                    <div class="w-20 border border-gray-300 bg-gray-50 rounded-lg px-3 py-2 text-center font-semibold text-gray-700">
                                        5%
                                    </div>
                                </div>
                        ...
                        <tr class="kpa-row hover:bg-purple-50/50 transition duration-150">
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <input type="hidden" name="kpas[7][category]" value="WORK PERFORMANCE">
                                <input type="hidden" name="kpas[7][kpa]" value="Reporting">
                                <input type="hidden" name="kpas[7][result_indicators]" value="Submit financial and operational reports on time as per company requirements">
                            </td>
                            <td class="px-6 py-4">
                                <div class="text-sm text-gray-900 font-medium">Submit financial and operational reports on time as per company requirements</div>
                                <div class="text-xs text-gray-500 mt-1">
                                    <span class="inline-block px-2 py-1 bg-gray-100 rounded">ND - 1 point</span>
                                    <span class="inline-block px-2 py-1 bg-gray-100 rounded">NS - 2 points</span>
                                    <span class="inline-block px-2 py-1 bg-gray-100 rounded">S - 3 points</span>
                        ...
                        <!-- WORK PERFORMANCE - Team Management -->
                        <tr class="kpa-row hover:bg-purple-50/50 transition duration-150">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="bg-purple-100 text-purple-600 p-2 rounded mr-3">
                                    ...
                                    <div>
                                        <span class="font-semibold text-gray-900">WORK PERFORMANCE</span><br>
                                        <span class="text-xs text-gray-500">Team Management</span>
                                    </div>
                                </div>
                                <input type="hidden" name="kpas[8][category]" value="WORK PERFORMANCE">
                                <input type="hidden" name="kpas[8][kpa]" value="Team Management">
                                <input type="hidden" name="kpas[8][result_indicators]" value="Manage the Maintenance and Admin Team to ensure toll equipment remains in optimal working condition and daily administrative operations are organized and efficient">
                            </td>
                            <td class="px-6 py-4">
                                <div class="text-sm text-gray-900 font-medium">Manage the Maintenance and Admin Team to ensure toll equipment remains in optimal working condition and daily administrative operations are organized and efficient</div>
                                <div class="text-xs text-gray-500 mt-1">
                                    <span class="inline-block px-2 py-1 bg-gray-100 rounded">ND - 1 point</span>
                                    <span class="inline-block px-2 py-1 bg-gray-100 rounded">NS - 2 points</span>
                                    <span class="inline-block px-2 py-1 bg-gray-100 rounded">S - 3 points</span>
                            ...
                            <td class="px-6 py-4 weight-cell">
                                <div class="relative">
                                    <input type="hidden" name="kpas[8][weight]" value="5">
                                    <div class="w-20 border border-gray-300 bg-gray-50 rounded-lg px-3 py-2 text-center font-semibold text-gray-700">
                                        5%
                                    </div>
                                </div>
                        ...
                        <!-- WORK PERFORMANCE - Safety Management -->
                        <tr class="kpa-row hover:bg-purple-50/50 transition duration-150">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="bg-purple-100 text-purple-600 p-2 rounded mr-3">
                                    ...
                                    <div>
                                        <span class="font-semibold text-gray-900">WORK PERFORMANCE</span><br>
                                        <span class="text-xs text-gray-500">Safety Management</span>
                                    </div>
                                </div>
                                <input type="hidden" name="kpas[9][category]" value="WORK PERFORMANCE">
                                <input type="hidden" name="kpas[9][kpa]" value="Safety Management">
                                <input type="hidden" name="kpas[9][result_indicators]" value="Identify and mitigate safety risks, supervise security guard patrols and access control to ensure a safe working environment">
                            </td>
                            <td class="px-6 py-4">
                                <div class="text-sm text-gray-900 font-medium">Identify and mitigate safety risks, supervise security guard patrols and access control to ensure a safe working environment</div>
                                <div class="text-xs text-gray-500 mt-1">
                                    <span class="inline-block px-2 py-1 bg-gray-100 rounded">ND - 1 point</span>
                                    <span class="inline-block px-2 py-1 bg-gray-100 rounded">NS - 2 points</span>
                                    <span class="inline-block px-2 py-1 bg-gray-100 rounded">S - 3 points</span>
                            ...
                            <td class="px-6 py-4 weight-cell">
                                <div class="relative">
                                    <input type="hidden" name="kpas[9][weight]" value="3">
                                    <div class="w-20 border border-gray-300 bg-gray-50 rounded-lg px-3 py-2 text-center font-semibold text-gray-700">
                                        3%
                                    </div>
                                </div>
                        ...
                        <!-- WORK PERFORMANCE - External Relations -->
                        <tr class="kpa-row hover:bg-purple-50/50 transition duration-150">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="bg-purple-100 text-purple-600 p-2 rounded mr-3">
                                    ...
                                    <div>
                                        <span class="font-semibold text-gray-900">WORK PERFORMANCE</span><br>
                                        <span class="text-xs text-gray-500">External Relations</span>
                                    </div>
                                </div>
                                <input type="hidden" name="kpas[10][category]" value="WORK PERFORMANCE">
                                <input type="hidden" name="kpas[10][kpa]" value="External Relations">
                                <input type="hidden" name="kpas[10][result_indicators]" value="Handle visits, complaints, and collaboration from media and authorities, maintain a professional image, and foster positive external relationships">
                            </td>
                            <td class="px-6 py-4">
                                <div class="text-sm text-gray-900 font-medium">Handle visits, complaints, and collaboration from media and authorities, maintain a professional image, and foster positive external relationships</div>
                                <div class="text-xs text-gray-500 mt-1">
                                    <span class="inline-block px-2 py-1 bg-gray-100 rounded">ND - 1 point</span>
                                    <span class="inline-block px-2 py-1 bg-gray-100 rounded">NS - 2 points</span>
                                    <span class="inline-block px-2 py-1 bg-gray-100 rounded">S - 3 points</span>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <input type="hidden" name="kpas[10][kpi]" value="4">
                            </td>
                            <td class="px-6 py-4 weight-cell">
                                <div class="relative">
                                    <input type="hidden" name="kpas[10][weight]" value="2">
                                    <div class="w-20 border border-gray-300 bg-gray-50 rounded-lg px-3 py-2 text-center font-semibold text-gray-700">
                                        2%
                                    </div>
                                </div>
                            ...
                            <td class="px-6 py-4">
                                <select name="kpas[10][self_rating]" required 
                                        class="rating-select w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#110484] focus:border-transparent">
                                    <option value="">Select Rating</option>
                                    <option value="1">1 - ND (Not Demonstrated)</option>
                                    <option value="2">2 - NS (Not Satisfactory)</option>
                            ...
                            <td class="px-6 py-4 score-cell">
                                <div class="text-center font-semibold">
                                    <span id="scoreCell10">0%</span>
                                    <input type="hidden" name="kpas[10][calculated_score]" id="calculatedScore10" value="0">
                                </div>
                            </td>
                            <td class="px-6 py-4">
                                <div class="flex flex-col space-y-2">
                                    <div id="commentPreview10" class="comment-preview text-sm text-gray-600">
                                        <!-- Comment preview will be shown here -->
                                    </div>
                                    <button type="button" onclick="openCommentModal(10)" 
                                            class="inline-flex items-center justify-center px-3 py-1.5 bg-purple-50 text-purple-600 hover:bg-purple-100 rounded-lg text-sm font-medium transition duration-200">
                                        <i class="fas fa-edit mr-1.5"></i> Add/Edit Comment
                                    </button>
                                    <input type="hidden" name="kpas[10][comments]" id="commentInput10" value="">
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr class="kpa-row hover:bg-yellow-50/50 transition duration-150">
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <input type="hidden" name="kpas[11][category]" value="ATTITUDE">
                                <input type="hidden" name="kpas[11][kpa]" value="Attitude">
                                <input type="hidden" name="kpas[11][result_indicators]" value="Exhibit a proactive attitude, take initiative in tasks, and foster positive interactions with colleagues">
                            </td>
                            <td class="px-6 py-4">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <input type="hidden" name="kpas[11][kpi]" value="4">
                            </td>
                            <td class="px-6 py-4 weight-cell">
                                <div class="relative">
                                    <input type="hidden" name="kpas[11][weight]" value="5">
                                    <div class="w-20 border border-gray-300 bg-gray-50 rounded-lg px-3 py-2 text-center font-semibold text-gray-700">
                                        5%
                                    </div>
                                </div>
                            ...
                            <td class="px-6 py-4">
                                <select name="kpas[11][self_rating]" required 
                                        class="rating-select w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#110484] focus:border-transparent">
                                    <option value="">Select Rating</option>
                                    <option value="1">1 - ND (Not Demonstrated)</option>
                                    <option value="2">2 - NS (Not Satisfactory)</option>
                            ...
                            <td class="px-6 py-4 score-cell">
                                <div class="text-center font-semibold">
                                    <span id="scoreCell11">0%</span>
                                    <input type="hidden" name="kpas[11][calculated_score]" id="calculatedScore11" value="0">
                                </div>
                            </td>
                            <td class="px-6 py-4">
                                <div class="flex flex-col space-y-2">
                                    <div id="commentPreview11" class="comment-preview text-sm text-gray-600">
                                        <!-- Comment preview will be shown here -->
                                    </div>
                                    <button type="button" onclick="openCommentModal(11)" 
                                    ...
                                    <input type="hidden" name="kpas[11][comments]" id="commentInput11" value="">
                                </div>
                            </td>
                        </tr>
                ...
                <div class="space-y-4">
                    <div>
                        <div class="flex justify-between items-center mb-2">
                            ...
                            <span id="plazaTotalWeight" class="text-lg font-bold text-[#110484]">100%</span>
                        </div>
                        <div class="w-full bg-gray-200 rounded-full h-3 progress-bar">
                            <div id="plazaWeightProgress" class="bg-gradient-to-r from-green-500 to-emerald-500 h-3 rounded-full transition-all duration-500" style="width: 100%"></div>
                        </div>
                    </div>
                    <div id="plazaWeightStatus" class="flex items-center text-sm font-semibold text-green-600">
    ...
    <script>
        ...
        function calculateScores() {
            const form = document.getElementById('plazaManagerForm');
            const ratingSelects = form.querySelectorAll('select[name*="[self_rating]"]');
            
            let totalWeightedScore = 0;
            const weights = [10, 25, 10, 10, 10, 10, 5, 5, 5, 3, 2, 5]; // Fixed weights for Plaza Manager
        ...
        function calculateWeightTotal() {
            const totalWeight = 100; // Fixed at 100% for Plaza Manager
            
            // Update all displays
            const weightDisplay = document.getElementById('plazaTotalWeight');
            const weightStatsDisplay = document.getElementById('plazaTotalWeightDisplay');
            const progressBar = document.getElementById('plazaWeightProgress');
            const statusDiv = document.getElementById('plazaWeightStatus');
        ...
        function saveAsDraft() {
            document.getElementById('plazaFormStatus').value = 'draft';
            ...
            document.getElementById('plazaManagerForm').submit();
        }
        ...
        function submitForm() {
            ...
            if (confirm(confirmationMessage)) {
                document.getElementById('plazaFormStatus').value = 'submitted';
