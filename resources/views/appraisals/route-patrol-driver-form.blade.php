...
<head>
    ...
    <title>Route Patrol Driver Performance Appraisal - MOIC</title>
...
<body class="min-h-screen bg-gray-50">
                ...
                <div class="flex justify-between items-start">
                    <div class="flex-1">
                        <div class="flex items-center mb-3">
                            ...
                            <div>
                                <h1 class="text-2xl font-bold mb-1">Route Patrol Driver - Performance Appraisal</h1>
                        ...
                        <div class="flex flex-wrap gap-4 mt-4">
                            ...
                            <div class="bg-white/10 backdrop-blur-sm rounded-lg px-3 py-2">
                                ...
                                <p class="font-semibold text-white">Senior Driver / Admin Manager</p>
                            </div>
                        </div>
                    </div>
    ...
    <main class="max-w-7xl mx-auto">
        <form id="routePatrolDriverForm" action="{{ route('appraisals.store') }}" method="POST" class="bg-white rounded-lg shadow-lg p-6 border border-gray-200">
            @csrf
            ...
            <div class="flex justify-between items-center mb-6 pb-4 border-b border-gray-200">
                ...
                <span class="bg-gradient-to-r from-[#110484] to-[#1a0c9e] text-white px-3 py-1 rounded-full text-sm font-semibold">
                    <i class="fas fa-star mr-1"></i> 8 Key Performance Areas
                </span>
            </div>
                ...
                <div class="bg-gradient-to-r from-green-50 to-emerald-50 border border-emerald-100 rounded-lg p-4">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p id="driverTotalWeightDisplay" class="text-lg font-bold text-gray-800">100%</p>
                        </div>
                    </div>
                </div>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="kpa-row hover:bg-purple-50/50 transition duration-150">
                            ...
                            <td class="px-6 py-4">
                                <div class="text-sm text-gray-900 font-medium">Financial control: use of equipment, material and fuel within company budget 
                        ...
                        <tr class="kpa-row hover:bg-purple-50/50 transition duration-150">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        <span class="font-semibold text-gray-900">WORK PERFORMANCE</span><br>
                                        <span class="text-xs text-gray-500">Employee Transport</span>
                                    </div>
                                </div>
                            ...
                            <td class="px-6 py-4">
                                <div class="text-sm text-gray-900 font-medium">Following the designated pickup points, punctually transport employees, ensuring safe driving at all times 
                        ...
                        <tr class="kpa-row hover:bg-purple-50/50 transition duration-150">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        <span class="font-semibold text-gray-900">WORK PERFORMANCE</span><br>
                                        <span class="text-xs text-gray-500">Route Patrol</span>
                                    </div>
                                </div>
                            ...
                            <td class="px-6 py-4">
                                <div class="text-sm text-gray-900 font-medium">Complete route patrols, route clearance, route assistance, and reporting as per the designated routes and frequency 
                        ...
                        <tr class="kpa-row hover:bg-purple-50/50 transition duration-150">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        <span class="font-semibold text-gray-900">WORK PERFORMANCE</span><br>
                                        <span class="text-xs text-gray-500">Lane Cleaning</span>
                                    </div>
                                </div>
                            ...
                            <td class="px-6 py-4">
                                <div class="text-sm text-gray-900 font-medium">Perform lane cleaning at the specified time and frequency without visible stains or debris</div>
                                <div class="text-xs text-gray-500 mt-1">
                                    <span class="inline-block px-2 py-1 bg-gray-100 rounded">ND - 1 point</span>
                                    <span class="inline-block px-2 py-1 bg-gray-100 rounded">NS - 2 points</span>
                                    <span class="inline-block px-2 py-1 bg-gray-100 rounded">S - 3 points</span>
                        ...
                        <tr class="kpa-row hover:bg-purple-50/50 transition duration-150">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        <span class="font-semibold text-gray-900">WORK PERFORMANCE</span><br>
                                        <span class="text-xs text-gray-500">Vehicle Maintenance</span>
                                    </div>
                                </div>
                            ...
                            <td class="px-6 py-4">
                                <div class="text-sm text-gray-900 font-medium">Maintain the site vehicle in a clean and tidy condition at all times 
                ...
                <div class="space-y-4">
                    <div>
                        <div class="flex justify-between items-center mb-2">
                            ...
                            <span id="driverTotalWeight" class="text-lg font-bold text-[#110484]">100%</span>
                        </div>
                        <div class="w-full bg-gray-200 rounded-full h-3 progress-bar">
                            <div id="driverWeightProgress" class="bg-gradient-to-r from-green-500 to-emerald-500 h-3 rounded-full transition-all duration-500" style="width: 100%"></div>
                        </div>
                    </div>
                    <div id="driverWeightStatus" class="flex items-center text-sm font-semibold text-green-600">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="form-section bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-xl border border-gray-200">
                        ...
                        <textarea name="development_needs" rows="4" 
                                  ...
                                  placeholder="List your development needs for the next period (e.g., defensive driving courses, vehicle maintenance training, route optimization skills)..."></textarea>
                    </div>
                    ...
                    <div class="form-section bg-gradient-to-r from-green-50 to-emerald-50 p-6 rounded-xl border border-gray-200">
                        ...
                        <textarea name="employee_comments" rows="4" 
                                  class="w-full border border-gray-300 rounded-lg px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-[#110484] focus:border-transparent" 
                                  placeholder="Any additional comments or feedback about your performance, challenges faced, or suggestions for improvement..."></textarea>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        function calculateScores() {
            const form = document.getElementById('routePatrolDriverForm');
