...
<head>
    ...
    <title>Route Patrol Driver Performance Appraisal - MOIC Performance Appraisal System</title>
    ...
    <style>
        /* MOIC Brand Colors - Route Patrol Driver Theme (Navy/Blue with Accent) */
        :root {
            --moic-navy: #110484;
...
<body>
            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex align-items-center desktop-only">
                        ...
                        <div>
                            <h1 class="h5 mb-0 fw-bold" style="font-size: 1rem;">Route Patrol Driver Performance Appraisal</h1>
                            <p class="mb-0 text-white-50" style="font-size: 0.75rem;">{{ $currentQuarter }} {{ $quarterInfo->year }}</p>
                        </div>
                    </div>
                    
                    <div class="mobile-only ms-2">
                        <h1 class="h6 mb-0 fw-bold">Route Patrol Driver</h1>
                ...
                <div class="d-flex align-items-center gap-2">
                    <div class="desktop-only text-end me-2">
                        ...
                        <div class="small text-white-50">Route Patrol Driver</div>
                    </div>
    ...
    <main class="py-4">
        <div class="container-custom px-3">
                    ...
                    <div class="stat-card">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p class="fw-semibold mb-0">Senior Driver / Admin Manager</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- Main Form -->
            <form id="routePatrolDriverForm" action="{{ route('appraisals.store') }}" method="POST" class="card card-moic">
                @csrf
                <input type="hidden" name="status" id="driverFormStatus" value="draft">
                <input type="hidden" name="period" value="{{ $currentQuarter }}">
                <input type="hidden" name="start_date" value="{{ $startDate }}">
                <input type="hidden" name="end_date" value="{{ $endDate }}">
                <input type="hidden" name="job_title" value="Route Patrol Driver">
                            ...
                            <div class="bg-blue-50 p-3 rounded">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <p id="driverTotalWeightDisplay" class="h4 fw-bold moic-navy mb-0">100%</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="fw-medium">
                                        ...
                                        <input type="hidden" name="kpas[2][result_indicators]" value="Financial control: use of equipment, material and fuel within company budget">
                                    </td>
                                    <td>
                                        <div class="small">Financial control: use of equipment, material and fuel within company budget 
                                            <span class="critical-badge">COST CONTROL</span>
                                        </div>
                                        <div class="mt-1">
                                ...
                                <!-- WORK PERFORMANCE - Employee Transport -->
                                <tr>
                                    <td class="fw-medium">
                                        <div class="d-flex align-items-center">
                                            <div class="bg-purple-100 text-purple-600 p-2 rounded me-2">
                                            ...
                                            <div>
                                                WORK PERFORMANCE
                                                <small class="text-muted d-block">Employee Transport</small>
                                            </div>
                                        </div>
                                        <input type="hidden" name="kpas[3][category]" value="WORK PERFORMANCE">
                                        <input type="hidden" name="kpas[3][kpa]" value="Employee Transport">
                                        <input type="hidden" name="kpas[3][result_indicators]" value="Following the designated pickup points, punctually transport employees, ensuring safe driving at all times">
                                    </td>
                                    <td>
                                        <div class="small">Following the designated pickup points, punctually transport employees, ensuring safe driving at all times 
                                            <span class="safety-badge">SAFETY</span>
                                        </div>
                                        <div class="mt-1">
                                            <span class="badge bg-gray-100 text-gray-800 me-1">ND - 1</span>
                                            <span class="badge bg-gray-100 text-gray-800 me-1">NS - 2</span>
                                ...
                                <tr>
                                    <td class="fw-medium">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                WORK PERFORMANCE
                                                <small class="text-muted d-block">Route Patrol</small>
                                            </div>
                                        </div>
                                        <input type="hidden" name="kpas[4][category]" value="WORK PERFORMANCE">
                                        <input type="hidden" name="kpas[4][kpa]" value="Route Patrol">
                                        <input type="hidden" name="kpas[4][result_indicators]" value="Complete route patrols, route clearance, route assistance, and reporting as per the designated routes and frequency">
                                    </td>
                                    <td>
                                        <div class="small">Complete route patrols, route clearance, route assistance, and reporting as per the designated routes and frequency 
                                            <span class="critical-badge">CORE DUTY</span>
                                        </div>
                                        <div class="mt-1">
                                            <span class="badge bg-gray-100 text-gray-800 me-1">ND - 1</span>
                                            <span class="badge bg-gray-100 text-gray-800 me-1">NS - 2</span>
                                ...
                                <!-- WORK PERFORMANCE - Lane Cleaning -->
                                <tr>
                                    <td class="fw-medium">
                                        <div class="d-flex align-items-center">
                                            <div class="bg-purple-100 text-purple-600 p-2 rounded me-2">
                                            ...
                                            <div>
                                                WORK PERFORMANCE
                                                <small class="text-muted d-block">Lane Cleaning</small>
                                            </div>
                                        </div>
                                        <input type="hidden" name="kpas[5][category]" value="WORK PERFORMANCE">
                                        <input type="hidden" name="kpas[5][kpa]" value="Lane Cleaning">
                                        <input type="hidden" name="kpas[5][result_indicators]" value="Perform lane cleaning at the specified time and frequency without visible stains or debris">
                                    </td>
                                    <td>
                                        <div class="small">Perform lane cleaning at the specified time and frequency without visible stains or debris</div>
                                        <div class="mt-1">
                                            <span class="badge bg-gray-100 text-gray-800 me-1">ND - 1</span>
                                            <span class="badge bg-gray-100 text-gray-800 me-1">NS - 2</span>
                                            <span class="badge bg-gray-100 text-gray-800 me-1">S - 3</span>
                                ...
                                <!-- WORK PERFORMANCE - Vehicle Maintenance -->
                                <tr>
                                    <td class="fw-medium">
                                        <div class="d-flex align-items-center">
                                            <div class="bg-purple-100 text-purple-600 p-2 rounded me-2">
                                            ...
                                            <div>
                                                WORK PERFORMANCE
                                                <small class="text-muted d-block">Vehicle Maintenance</small>
                                            </div>
                                        </div>
                                        <input type="hidden" name="kpas[6][category]" value="WORK PERFORMANCE">
                                        <input type="hidden" name="kpas[6][kpa]" value="Vehicle Maintenance">
                                        <input type="hidden" name="kpas[6][result_indicators]" value="Maintain the site vehicle in a clean and tidy condition at all times">
                                    </td>
                                    <td>
                                        <div class="small">Maintain the site vehicle in a clean and tidy condition at all times 
                                            <span class="vehicle-badge">VEHICLE CARE</span>
                                        </div>
                                        <div class="mt-1">
                                            <span class="badge bg-gray-100 text-gray-800 me-1">ND - 1</span>
                                            <span class="badge bg-gray-100 text-gray-800 me-1">NS - 2</span>
                        ...
                        <div class="col-12">
                            <div class="bg-gray-50 p-4 rounded border">
                                ...
                                <div class="mb-2 d-flex justify-content-between">
                                    ...
                                    <span id="driverTotalWeight" class="fw-bold moic-navy">100%</span>
                                </div>
                                <div class="progress-moic">
                                    <div id="driverWeightProgress" class="progress-bar-moic" style="width: 100%; height: 100%;"></div>
                                </div>
                                <div id="driverWeightStatus" class="mt-2 small text-success">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            <div class="bg-blue-50 p-4 rounded border">
                                ...
                                <textarea name="development_needs" rows="4" class="form-control" placeholder="List your development needs for the next period (e.g., defensive driving courses, vehicle maintenance training, route optimization skills)..."></textarea>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="bg-green-50 p-4 rounded border">
                                ...
                                <textarea name="employee_comments" rows="4" class="form-control" placeholder="Any additional comments or feedback about your performance, challenges faced, or suggestions for improvement..."></textarea>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        const weights = [10, 25, 15, 15, 10, 10, 10, 5]; // Fixed weights for Route Patrol Driver
        ...
        function calculateWeightTotal() {
            const totalWeight = 100; // Fixed at 100% for Route Patrol Driver
            
            // Update all displays
            const weightDisplay = document.getElementById('driverTotalWeight');
            const weightStatsDisplay = document.getElementById('driverTotalWeightDisplay');
            const progressBar = document.getElementById('driverWeightProgress');
            const statusDiv = document.getElementById('driverWeightStatus');
        ...
        function saveAsDraft(event) {
            ...
            document.getElementById('driverFormStatus').value = 'draft';
            ...
            setTimeout(() => {
                document.getElementById('routePatrolDriverForm').submit();
            }, 1500);
        }
        ...
        function submitForm(event) {
            ...
            if (confirm(confirmationMessage)) {
                document.getElementById('driverFormStatus').value = 'submitted';
