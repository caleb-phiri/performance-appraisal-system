...
<head>
    ...
    <title>Plaza Attendant Performance Appraisal - MOIC</title>
...
<body class="min-h-screen bg-gray-50">
                ...
                <div class="flex justify-between items-start">
                    <div class="flex-1">
                        <div class="flex items-center mb-3">
                            ...
                            <div>
                                <h1 class="text-2xl font-bold mb-1">Plaza Attendant - Performance Appraisal</h1>
                        ...
                        <div class="flex flex-wrap gap-4 mt-4">
                            ...
                            <div class="bg-white/10 backdrop-blur-sm rounded-lg px-3 py-2">
                                ...
                                <p class="font-semibold text-white">Admin Manager</p>
                            </div>
                        </div>
                    </div>
    ...
    <main class="max-w-7xl mx-auto">
        <form id="plazaAttendantForm" action="{{ route('appraisals.store') }}" method="POST" class="bg-white rounded-lg shadow-lg p-6 border border-gray-200">
            @csrf
                ...
                <div class="bg-gradient-to-r from-green-50 to-emerald-50 border border-emerald-100 rounded-lg p-4">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p id="plazaAttendantTotalWeightDisplay" class="text-lg font-bold text-gray-800">100%</p>
                        </div>
                    </div>
                </div>
                        ...
                        <tr class="kpa-row hover:bg-purple-50/50 transition duration-150">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        <span class="font-semibold text-gray-900">WORK PERFORMANCE</span><br>
                                        <span class="text-xs text-gray-500">Plaza Office Hygiene</span>
                                    </div>
                                </div>
                            ...
                            <td class="px-6 py-4">
                                <div class="text-sm text-gray-900 font-medium">Ensure that plaza office areas are hygienically maintained and cleaned 
                        ...
                        <tr class="kpa-row hover:bg-purple-50/50 transition duration-150">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        <span class="font-semibold text-gray-900">WORK PERFORMANCE</span><br>
                                        <span class="text-xs text-gray-500">Full Area Cleaning</span>
                                    </div>
                                </div>
                            ...
                            <td class="px-6 py-4">
                                <div class="text-sm text-gray-900 font-medium">Complete full-area cleaning and necessary touch-ups within designated working hours</div>
                                <div class="text-xs text-gray-500 mt-1">
                                    <span class="inline-block px-2 py-1 bg-gray-100 rounded">ND - 1 point</span>
                                    <span class="inline-block px-2 py-1 bg-gray-100 rounded">NS - 2 points</span>
                                    <span class="inline-block px-2 py-1 bg-gray-100 rounded">S - 3 points</span>
                        ...
                        <tr class="kpa-row hover:bg-purple-50/50 transition duration-150">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        <span class="font-semibold text-gray-900">WORK PERFORMANCE</span><br>
                                        <span class="text-xs text-gray-500">Spillage Response</span>
                                    </div>
                                </div>
                            ...
                            <td class="px-6 py-4">
                                <div class="text-sm text-gray-900 font-medium">Promptly and effectively handle various types of spillage incidents</div>
                                <div class="text-xs text-gray-500 mt-1">
                                    <span class="inline-block px-2 py-1 bg-gray-100 rounded">ND - 1 point</span>
                                    <span class="inline-block px-2 py-1 bg-gray-100 rounded">NS - 2 points</span>
                                    <span class="inline-block px-2 py-1 bg-gray-100 rounded">S - 3 points</span>
                        ...
                        <tr class="kpa-row hover:bg-purple-50/50 transition duration-150">
                            ...
                            <td class="px-6 py-4">
                                ...
                                <div class="mt-2 p-2 bg-yellow-50 rounded text-xs text-yellow-800">
                                    ...
                                    <strong>PPE/PPC Includes:</strong> Gloves, masks, goggles, aprons, safety shoes, and other protective gear as required for specific cleaning tasks.
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="inline-flex items-center justify-center w-10 h-10 bg-purple-100 text-purple-600 rounded-full font-bold">
                ...
                <div class="space-y-4">
                    <div>
                        <div class="flex justify-between items-center mb-2">
                            ...
                            <span id="plazaAttendantTotalWeight" class="text-lg font-bold text-[#110484]">100%</span>
                        </div>
                        <div class="w-full bg-gray-200 rounded-full h-3 progress-bar">
                            <div id="plazaAttendantWeightProgress" class="bg-gradient-to-r from-green-500 to-emerald-500 h-3 rounded-full transition-all duration-500" style="width: 100%"></div>
                        </div>
                    </div>
                    <div id="plazaAttendantWeightStatus" class="flex items-center text-sm font-semibold text-green-600">
    ...
    <script>
        ...
        function calculateScores() {
            const form = document.getElementById('plazaAttendantForm');
        ...
        function submitForm() {
            ...
            if (!safetyCheckbox.checked) {
                if (!confirm('You have not acknowledged the safety compliance requirement. Are you sure you want to continue without safety acknowledgement?')) {
                    return;
                }
            }
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            safetyCheckbox.addEventListener('change', function() {
                const safetySection = this.closest('.bg-gradient-to-r');
                if (this.checked) {
                    safetySection.classList.remove('border-red-300');
                    safetySection.classList.add('border-yellow-200');
                } else {
                    safetySection.classList.remove('border-yellow-200');
