...
<head>
    ...
    <title>Plaza Attendant Performance Appraisal - MOIC Performance Appraisal System</title>
    ...
    <style>
        /* MOIC Brand Colors - Plaza Attendant Theme (Navy/Blue) */
        :root {
            --moic-navy: #110484;
...
<body>
            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex align-items-center desktop-only">
                        ...
                        <div>
                            <h1 class="h5 mb-0 fw-bold" style="font-size: 1rem;">Plaza Attendant Performance Appraisal</h1>
                            <p class="mb-0 text-white-50" style="font-size: 0.75rem;">{{ $currentQuarter }} {{ $quarterInfo->year }}</p>
                        </div>
                    </div>
                    
                    <div class="mobile-only ms-2">
                        <h1 class="h6 mb-0 fw-bold">Plaza Attendant</h1>
                ...
                <div class="d-flex align-items-center gap-2">
                    <div class="desktop-only text-end me-2">
                        ...
                        <div class="small text-white-50">Plaza Attendant</div>
                    </div>
    ...
    <main class="py-4">
        <div class="container-custom px-3">
                    ...
                    <div class="stat-card">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p class="fw-semibold mb-0">Admin Manager</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- Main Form -->
            <form id="plazaAttendantForm" action="{{ route('appraisals.store') }}" method="POST" class="card card-moic">
                @csrf
                ...
                <input type="hidden" name="job_title" value="Plaza Attendant">
                            ...
                            <div class="bg-blue-50 p-3 rounded">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <p id="plazaAttendantTotalWeightDisplay" class="h4 fw-bold moic-navy mb-0">100%</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="table-responsive mb-4">
                        <table class="table table-moic mb-0">
                            ...
                            <tbody>
                                ...
                                <!-- WORK PERFORMANCE - Plaza Office Hygiene -->
                                <tr>
                                    <td class="fw-medium">
                                        <div class="d-flex align-items-center">
                                            <div class="bg-purple-100 text-purple-600 p-2 rounded me-2">
                                            ...
                                            <div>
                                                WORK PERFORMANCE
                                                <small class="text-muted d-block">Plaza Office Hygiene</small>
                                            </div>
                                        </div>
                                        <input type="hidden" name="kpas[3][category]" value="WORK PERFORMANCE">
                                        <input type="hidden" name="kpas[3][kpa]" value="Plaza Office Hygiene">
                                        <input type="hidden" name="kpas[3][result_indicators]" value="Ensure that plaza office areas are hygienically maintained and cleaned">
                                    </td>
                                    <td>
                                        <div class="small">Ensure that plaza office areas are hygienically maintained and cleaned 
                                            <span class="hygiene-badge">HYGIENE</span>
                                        </div>
                                        <div class="mt-1">
                                            <span class="badge bg-gray-100 text-gray-800 me-1">ND - 1</span>
                                            <span class="badge bg-gray-100 text-gray-800 me-1">NS - 2</span>
                                ...
                                <!-- WORK PERFORMANCE - Full Area Cleaning -->
                                <tr>
                                    <td class="fw-medium">
                                        <div class="d-flex align-items-center">
                                            <div class="bg-purple-100 text-purple-600 p-2 rounded me-2">
                                            ...
                                            <div>
                                                WORK PERFORMANCE
                                                <small class="text-muted d-block">Full Area Cleaning</small>
                                            </div>
                                        </div>
                                        <input type="hidden" name="kpas[4][category]" value="WORK PERFORMANCE">
                                        <input type="hidden" name="kpas[4][kpa]" value="Full Area Cleaning">
                                        <input type="hidden" name="kpas[4][result_indicators]" value="Complete full-area cleaning and necessary touch-ups within designated working hours">
                                    </td>
                                    <td>
                                        <div class="small">Complete full-area cleaning and necessary touch-ups within designated working hours</div>
                                        <div class="mt-1">
                                            <span class="badge bg-gray-100 text-gray-800 me-1">ND - 1</span>
                                            <span class="badge bg-gray-100 text-gray-800 me-1">NS - 2</span>
                                            <span class="badge bg-gray-100 text-gray-800 me-1">S - 3</span>
                             ...
                             <!-- WORK PERFORMANCE - Spillage Response -->
<tr>
    <td class="fw-medium">
        <div class="d-flex align-items-center">
            <div class="bg-purple-100 text-purple-600 p-2 rounded me-2">
            ...
            <div>
                WORK PERFORMANCE
                <small class="text-muted d-block">Spillage Response</small>
            </div>
        </div>
        <input type="hidden" name="kpas[5][category]" value="WORK PERFORMANCE">
        <input type="hidden" name="kpas[5][kpa]" value="Spillage Response">
        <input type="hidden" name="kpas[5][result_indicators]" value="Promptly and effectively handle various types of spillage incidents">
    </td>
    <td>
        <div class="small">Promptly and effectively handle various types of spillage incidents</div>
        <div class="mt-1">
            <span class="badge bg-gray-100 text-gray-800 me-1">ND - 1</span>
            <span class="badge bg-gray-100 text-gray-800 me-1">NS - 2</span>
            <span class="badge bg-gray-100 text-gray-800 me-1">S - 3</span>
        ...
        <div class="mt-2 p-2 bg-yellow-50 rounded small text-yellow-800">
            ...
            <strong>Safety:</strong> Follow proper spill response protocols for chemical and biological hazards
        </div>
    </td>
    <td>
        <span class="badge bg-purple-100 text-purple-800 rounded-pill px-3 py-2">4</span>
    ...
    <td>
        <div class="d-flex flex-column gap-2">
            ...
            <input type="hidden" name="kpas[5][comments]" id="commentInput5" value="">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="mt-2 p-2 bg-yellow-50 rounded small text-yellow-800">
                                            ...
                                            <strong>PPE Includes:</strong> Gloves, masks, goggles, aprons, safety shoes, and chemical-resistant gear
                                        </div>
                                    </td>
                                    <td>
                                        <span class="badge bg-purple-100 text-purple-800 rounded-pill px-3 py-2">4</span>
                        ...
                        <div class="col-12">
                            <div class="bg-gray-50 p-4 rounded border">
                                ...
                                <div class="mb-2 d-flex justify-content-between">
                                    ...
                                    <span id="plazaAttendantTotalWeight" class="fw-bold moic-navy">100%</span>
                                </div>
                                <div class="progress-moic">
                                    <div id="plazaAttendantWeightProgress" class="progress-bar-moic" style="width: 100%; height: 100%;"></div>
                                </div>
                                <div id="plazaAttendantWeightStatus" class="mt-2 small text-success">
                    ...
                    <!-- Chemical Safety Section -->
                    <div class="chemical-safety mb-4">
                        <h6 class="fw-bold mb-3 d-flex align-items-center">
                            <i class="fas fa-flask moic-navy me-2"></i>
                            Chemical Safety Acknowledgement
                        </h6>
                        <div class="d-flex align-items-start gap-3">
                            <input type="checkbox" class="safety-checkbox mt-1" id="safety_acknowledgement" name="safety_acknowledgement" value="1">
                            <div>
                                <label for="safety_acknowledgement" class="fw-semibold mb-1">I acknowledge that I will follow all safety protocols when handling cleaning chemicals</label>
                                <p class="small text-muted mb-0">This includes proper PPE use, correct chemical mixing procedures, adequate ventilation, and proper disposal methods. I will report any chemical spills or safety concerns immediately.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            <div class="bg-blue-50 p-4 rounded border">
                                ...
                                <textarea name="development_needs" rows="4" class="form-control" placeholder="List your development needs for the next period (e.g., cleaning techniques, chemical handling certification, time management, safety training)..."></textarea>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="bg-green-50 p-4 rounded border">
                                ...
                                <textarea name="employee_comments" rows="4" class="form-control" placeholder="Any additional comments or feedback about your performance, challenges with specific cleaning tasks, equipment issues, or suggestions for improvement..."></textarea>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        const weights = [10, 25, 15, 15, 10, 10, 10, 5]; // Fixed weights for Plaza Attendant
        ...
        function calculateWeightTotal() {
            const totalWeight = 100; // Fixed at 100% for Plaza Attendant
            
            // Update all displays
            const weightDisplay = document.getElementById('plazaAttendantTotalWeight');
            const weightStatsDisplay = document.getElementById('plazaAttendantTotalWeightDisplay');
            const progressBar = document.getElementById('plazaAttendantWeightProgress');
            const statusDiv = document.getElementById('plazaAttendantWeightStatus');
        ...
        function saveAsDraft(event) {
            ...
            setTimeout(() => {
                document.getElementById('plazaAttendantForm').submit();
            }, 1500);
        }
        ...
        function submitForm(event) {
            ...
            const safetyCheckbox = document.getElementById('safety_acknowledgement');
            if (safetyCheckbox && !safetyCheckbox.checked) {
                if (!confirm('You have not acknowledged the chemical safety requirement. Are you sure you want to continue without safety acknowledgement?')) {
                    return;
                }
            }
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (safetyCheckbox) {
                safetyCheckbox.addEventListener('change', function() {
                    const safetySection = this.closest('.chemical-safety');
                    if (this.checked) {
                        safetySection.classList.remove('border-red-300');
                        safetySection.classList.add('border-blue-300');
                    } else {
                        safetySection.classList.remove('border-blue-300');
                        safetySection.classList.add('border-red-300');
                    }
                });
            }
