...
<head>
    ...
    <title>E&M Technician Performance Appraisal - MOIC</title>
...
<body class="min-h-screen bg-gray-50">
                ...
                <div class="flex justify-between items-start">
                    <div class="flex-1">
                        <div class="flex items-center mb-3">
                            ...
                            <div>
                                <h1 class="text-2xl font-bold mb-1">E&M Technician - Performance Appraisal</h1>
    ...
    <main class="max-w-7xl mx-auto">
        <form id="emTechnicianForm" action="{{ route('appraisals.store') }}" method="POST" class="bg-white rounded-lg shadow-lg p-6 border border-gray-200">
            @csrf
            ...
            <div class="flex justify-between items-center mb-6 pb-4 border-b border-gray-200">
                ...
                <span class="bg-gradient-to-r from-green-500 to-emerald-600 text-white px-3 py-1 rounded-full text-sm font-semibold">
                    <i class="fas fa-cogs mr-1"></i> Technical Position
                </span>
            </div>
                ...
                <div class="bg-gradient-to-r from-green-50 to-emerald-50 border border-emerald-100 rounded-lg p-4">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p id="emTotalWeightDisplay" class="text-lg font-bold text-gray-800">100%</p>
                        </div>
                    </div>
                </div>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="kpa-row hover:bg-purple-50/50 transition duration-150">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <span class="text-xs text-gray-500">Electrical Maintenance</span>
                                    </div>
                                </div>
                            ...
                            <td class="px-6 py-4">
                                <div class="text-sm text-gray-900 font-medium">Perform regular electrical system inspections, maintenance, and troubleshooting to prevent power-related toll equipment failures 
                        ...
                        <tr class="kpa-row hover:bg-purple-50/50 transition duration-150">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        <span class="font-semibold text-gray-900">WORK PERFORMANCE</span><br>
                                        <span class="text-xs text-gray-500">Mechanical Maintenance</span>
                                    </div>
                                </div>
                            ...
                            <td class="px-6 py-4">
                                <div class="text-sm text-gray-900 font-medium">Maintain mechanical components of toll equipment including barriers, gates, and other moving parts to ensure smooth operation</div>
                                <div class="text-xs text-gray-500 mt-1">
                                    <span class="inline-block px-2 py-1 bg-gray-100 rounded">ND - 1 point</span>
                                    <span class="inline-block px-2 py-1 bg-gray-100 rounded">NS - 2 points</span>
                                    <span class="inline-block px-2 py-1 bg-gray-100 rounded">S - 3 points</span>
                        ...
                        <tr class="kpa-row hover:bg-purple-50/50 transition duration-150">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        <span class="font-semibold text-gray-900">WORK PERFORMANCE</span><br>
                                        <span class="text-xs text-gray-500">Preventive Maintenance</span>
                                    </div>
                                </div>
                            ...
                            <td class="px-6 py-4">
                                <div class="text-sm text-gray-900 font-medium">Execute scheduled preventive maintenance tasks according to maintenance calendar to minimize unexpected breakdowns</div>
                                <div class="text-xs text-gray-500 mt-1">
                                    <span class="inline-block px-2 py-1 bg-gray-100 rounded">ND - 1 point</span>
                                    <span class="inline-block px-2 py-1 bg-gray-100 rounded">NS - 2 points</span>
                                    <span class="inline-block px-2 py-1 bg-gray-100 rounded">S - 3 points</span>
                        ...
                        <tr class="kpa-row hover:bg-purple-50/50 transition duration-150">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        <span class="font-semibold text-gray-900">WORK PERFORMANCE</span><br>
                                        <span class="text-xs text-gray-500">Emergency Repairs</span>
                                    </div>
                                </div>
                            ...
                            <td class="px-6 py-4">
                                <div class="text-sm text-gray-900 font-medium">Respond promptly to emergency breakdowns and perform urgent repairs to restore equipment functionality quickly</div>
                                <div class="text-xs text-gray-500 mt-1">
                                    <span class="inline-block px-2 py-1 bg-gray-100 rounded">ND - 1 point</span>
                                    <span class="inline-block px-2 py-1 bg-gray-100 rounded">NS - 2 points</span>
                                    <span class="inline-block px-2 py-1 bg-gray-100 rounded">S - 3 points</span>
                        ...
                        <tr class="kpa-row hover:bg-purple-50/50 transition duration-150">
                            ...
                            <td class="px-6 py-4">
                                <div class="text-sm text-gray-900 font-medium">Document maintenance activities, equipment status, and repairs in maintenance logs and reports</div>
                                <div class="text-xs text-gray-500 mt-1">
                                    <span class="inline-block px-2 py-1 bg-gray-100 rounded">ND - 1 point</span>
                                    <span class="inline-block px-2 py-1 bg-gray-100 rounded">NS - 2 points</span>
                                    <span class="inline-block px-2 py-1 bg-gray-100 rounded">S - 3 points</span>
                ...
                <div class="space-y-4">
                    <div>
                        <div class="flex justify-between items-center mb-2">
                            ...
                            <span id="emTotalWeight" class="text-lg font-bold text-[#110484]">100%</span>
                        </div>
                        <div class="w-full bg-gray-200 rounded-full h-3 progress-bar">
                            <div id="emWeightProgress" class="bg-gradient-to-r from-green-500 to-emerald-500 h-3 rounded-full transition-all duration-500" style="width: 100%"></div>
                        </div>
                    </div>
                    <div id="emWeightStatus" class="flex items-center text-sm font-semibold text-green-600">
    ...
    <script>
        ...
        function calculateScores() {
            const form = document.getElementById('emTechnicianForm');
        ...
        function calculateWeightTotal() {
            const totalWeight = 100; // Fixed total weight for E&M Technician
            const totalWeightDisplay = document.getElementById('emTotalWeightDisplay');
            const totalWeightElement = document.getElementById('emTotalWeight');
            const weightProgress = document.getElementById('emWeightProgress');
            const weightStatus = document.getElementById('emWeightStatus');
            ...
            // Update status
            if (totalWeight === 100) {
                weightStatus.innerHTML = '<i class="fas fa-check-circle mr-2"></i><span>Total weight equals 100% - Ready for submission</span>';
                weightStatus.className = 'flex items-center text-sm font-semibold text-green-600';
            } else if (totalWeight < 100) {
                weightStatus.innerHTML = `<i class="fas fa-exclamation-circle mr-2"></i><span>Total weight is ${totalWeight}% (${100-totalWeight}% missing)</span>`;
                weightStatus.className = 'flex items-center text-sm font-semibold text-red-600';
            } else {
                weightStatus.innerHTML = `<i class="fas fa-exclamation-triangle mr-2"></i><span>Total weight is ${totalWeight}% (${totalWeight-100}% over)</span>`;
                weightStatus.className = 'flex items-center text-sm font-semibold text-amber-600';
            }
        ...
        function saveAsDraft() {
            const form = document.getElementById('emTechnicianForm');
            const statusInput = document.getElementById('emFormStatus');
            
            statusInput.value = 'draft';
            
            // Show confirmation
            showNotification('Appraisal saved as draft successfully!', 'success');
        ...
        function submitForm() {
            const form = document.getElementById('emTechnicianForm');
            const statusInput = document.getElementById('emFormStatus');
            const ratingSelects = document.querySelectorAll('select[name*="[self_rating]"]');
            ...
            ratingSelects.forEach((select, index) => {
                if (!select.value) {
                    ...
                    select.classList.add('ring-red-200');
                    
                    // Scroll to first missing rating
                    if (allRatingsSelected === false) {
                        select.scrollIntoView({ behavior: 'smooth', block: 'center' });
                        allRatingsSelected = null; // Prevent multiple scrolls
                    }
                } else {
                    select.classList.remove('border-red-500');
                    select.classList.remove('ring-2');
                    select.classList.remove('ring-red-200');
                }
            });
            
            if (!allRatingsSelected) {
                showNotification('Please select all ratings before submitting.', 'error');
                return;
            }
            
            // Validate total weight
            const totalWeight = 100; // Fixed for E&M Technician
            if (totalWeight !== 100) {
                showNotification('Total weight must equal 100% before submitting.', 'error');
                return;
            }
            
            // Confirm submission
            if (confirm('Are you sure you want to submit this appraisal? Once submitted, you cannot make changes.')) {
        ...
        function showNotification(message, type) {
            ...
            notification.className = `form-notification fixed top-4 right-4 z-50 max-w-sm w-full bg-white rounded-lg shadow-lg border-l-4 overflow-hidden ${
        ...
        document.addEventListener('DOMContentLoaded', function() {
            // Calculate initial weights and scores
            ...
            form.addEventListener('submit', function(event) {
                ...
                // If form is being submitted (not draft), do additional validation
                if (statusInput.value === 'submitted') {
                    const ratingSelects = document.querySelectorAll('select[name*="[self_rating]"]');
                    let allRatingsSelected = true;
        ...
        // Add export functionality (for debugging/printing)
        function exportFormData() {
            const formData = new FormData(document.getElementById('emTechnicianForm'));
            const data = {};
            ...
            // Calculate scores
            data.totalScore = document.getElementById('displayTotalScore').textContent;
            data.totalPercentage = document.getElementById('displayTotalPercentage').textContent;
            data.performanceRating = document.getElementById('performanceRating').textContent;
            
            // Create downloadable JSON
            const dataStr = JSON.stringify(data, null, 2);
            const dataUri = 'data:application/json;charset=utf-8,'+ encodeURIComponent(dataStr);
            
            const exportFileDefaultName = `E&M_Technician_Appraisal_${new Date().toISOString().split('T')[0]}.json`;
