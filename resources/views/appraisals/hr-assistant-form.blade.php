...
<head>
    ...
    <title>HR Assistant Performance Appraisal - MOIC Performance Appraisal System</title>
...
<body>
    @php
        ...
        function getQuarterInfoWithGrace($year = null, $quarter = null) {
            ...
            $quarters = [
                'Q1' => [
                    ...
                    'appraisal_end' => $currentYear . '-04-10',
                    'review_start' => $currentYear . '-04-11',
                    'review_end' => $currentYear . '-04-18',
                ],
                'Q2' => [
                    'name' => 'Quarter 2',
                    'months' => 'April - June',
                    ...
                    'appraisal_end' => $currentYear . '-07-10',
                    'review_start' => $currentYear . '-07-11',
                    'review_end' => $currentYear . '-07-18',
                ],
                'Q3' => [
                    'name' => 'Quarter 3',
                    ...
                    'appraisal_end' => $currentYear . '-10-10',
                    'review_start' => $currentYear . '-10-11',
                    'review_end' => $currentYear . '-10-18',
                ],
                'Q4' => [
                    'name' => 'Quarter 4',
                    ...
                    'appraisal_end' => ($currentYear + 1) . '-01-10',
                    'review_start' => ($currentYear + 1) . '-01-11',
                    'review_end' => ($currentYear + 1) . '-01-18',
                ],
            ];
            ...
            if ($quarter && isset($quarters[$quarter])) {
                ...
                $appraisalEndDate = \Carbon\Carbon::parse($q['appraisal_end']);
                ...
                return (object) [
                    ...
                    'due_date_formatted' => $graceEndDate->format('F j'),
                    'due_date_timestamp' => $graceEndDate->timestamp,
                    'appraisal_end' => $appraisalEndDate->format('M d'),
                    'appraisal_end_formatted' => $appraisalEndDate->format('F j'),
                    'review_start' => \Carbon\Carbon::parse($q['review_start'])->format('M d'),
                    'review_end' => \Carbon\Carbon::parse($q['review_end'])->format('M d'),
        ...
        // Check if user has already submitted for this quarter (you'll need to implement this)
        $hasAnySubmissionThisQuarter = false; // Replace with actual check
    @endphp
            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex align-items-center desktop-only">
                        ...
                        <div>
                            <h1 class="h5 mb-0 fw-bold" style="font-size: 1rem;">HR Assistant Performance Appraisal</h1>
                            <p class="mb-0 text-white-50" style="font-size: 0.75rem;">{{ $currentQuarter }} {{ $quarterInfo->year }}</p>
                        </div>
                    </div>
                    
                    <div class="mobile-only ms-2">
                        <h1 class="h6 mb-0 fw-bold">HR Assistant</h1>
                ...
                <div class="d-flex align-items-center gap-2">
                    <div class="desktop-only text-end me-2">
                        ...
                        <div class="small text-white-50">HR Assistant</div>
                    </div>
    ...
    <main class="py-4">
        <div class="container-custom px-3">
                    ...
                    <div class="stat-card">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p class="fw-semibold mb-0">HQ HR Officer</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- Main Form -->
            <form id="hrAssistantForm" action="{{ route('appraisals.store') }}" method="POST" class="card card-moic">
                @csrf
                <input type="hidden" name="status" id="hrFormStatus" value="draft">
                <input type="hidden" name="period" value="{{ $currentQuarter }}">
                <input type="hidden" name="start_date" value="{{ $startDate }}">
                <input type="hidden" name="end_date" value="{{ $endDate }}">
                <input type="hidden" name="job_title" value="HR Assistant">
                    ...
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <span class="badge bg-info text-white" style="padding: 0.5rem 1rem;">
                                <i class="fas fa-calculator me-1"></i> Payroll
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                            ...
                            <div class="bg-blue-50 p-3 rounded">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <p id="hrTotalWeightDisplay" class="h4 fw-bold moic-navy mb-0">100%</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="table-responsive mb-4">
                        <table class="table table-moic mb-0">
                            ...
                            <tbody>
                                ...
                                <!-- WORK PERFORMANCE - Monthly Payroll Calculation -->
                                <tr>
                                    <td class="fw-medium">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                WORK PERFORMANCE
                                                <small class="text-muted d-block">Monthly Payroll Calculation</small>
                                            </div>
                                        </div>
                                        <input type="hidden" name="kpas[2][category]" value="WORK PERFORMANCE">
                                        <input type="hidden" name="kpas[2][kpa]" value="Monthly Payroll Calculation">
                                        <input type="hidden" name="kpas[2][result_indicators]" value="Ensure accurate monthly payroll calculation verification, complete cross-checking with manual payroll and Manpower Return, and submit verified results on time">
                                    </td>
                                    <td>
                                        <div class="small">Ensure accurate monthly payroll calculation verification, complete cross-checking with manual payroll and Manpower Return, and submit verified results on time 
                                ...
                                <!-- WORK PERFORMANCE - Payroll File Management -->
                                <tr>
                                    <td class="fw-medium">
                                        <div class="d-flex align-items-center">
                                            <div class="bg-purple-100 text-purple-600 p-2 rounded me-2">
                                            ...
                                            <div>
                                                WORK PERFORMANCE
                                                <small class="text-muted d-block">Payroll File Management</small>
                                            </div>
                                        </div>
                                        <input type="hidden" name="kpas[3][category]" value="WORK PERFORMANCE">
                                        <input type="hidden" name="kpas[3][kpa]" value="Payroll File Management">
                                        <input type="hidden" name="kpas[3][result_indicators]" value="Ensure Payroll File updated in system on time; data consistent with job requirements; discrepancies corrected before payroll calculation period">
                                    </td>
                                    <td>
                                        <div class="small">Ensure Payroll File updated in system on time; data consistent with job requirements; discrepancies corrected before payroll calculation period 
                                            <span class="payroll-badge">PAYROLL</span>
                                        </div>
                                        <div class="mt-1">
                                            <span class="badge bg-gray-100 text-gray-800 me-1">ND - 1</span>
                                            <span class="badge bg-gray-100 text-gray-800 me-1">NS - 2</span>
                                ...
                                <!-- WORK PERFORMANCE - OA Approvals Review -->
                                <tr>
                                    <td class="fw-medium">
                                        <div class="d-flex align-items-center">
                                            <div class="bg-purple-100 text-purple-600 p-2 rounded me-2">
                                            ...
                                            <div>
                                                WORK PERFORMANCE
                                                <small class="text-muted d-block">OA Approvals Review</small>
                                            </div>
                                        </div>
                                        <input type="hidden" name="kpas[4][category]" value="WORK PERFORMANCE">
                                        <input type="hidden" name="kpas[4][kpa]" value="OA Approvals Review">
                                        <input type="hidden" name="kpas[4][result_indicators]" value="Review weekly OA approvals (overtime, leave, shortage, shift-cover), follow up unresolved approvals, and submit a weekly summary report">
                                    </td>
                                    <td>
                                        <div class="small">Review weekly OA approvals (overtime, leave, shortage, shift-cover), follow up unresolved approvals, and submit a weekly summary report</div>
                                        <div class="mt-1">
                                            <span class="badge bg-gray-100 text-gray-800 me-1">ND - 1</span>
                                            <span class="badge bg-gray-100 text-gray-800 me-1">NS - 2</span>
                                            <span class="badge bg-gray-100 text-gray-800 me-1">S - 3</span>
                                ...
                                <!-- WORK PERFORMANCE - Roster Data Verification -->
                                <tr>
                                    <td class="fw-medium">
                                        <div class="d-flex align-items-center">
                                            <div class="bg-purple-100 text-purple-600 p-2 rounded me-2">
                                            ...
                                            <div>
                                                WORK PERFORMANCE
                                                <small class="text-muted d-block">Roster Data Verification</small>
                                            </div>
                                        </div>
                                        <input type="hidden" name="kpas[5][category]" value="WORK PERFORMANCE">
                                        <input type="hidden" name="kpas[5][kpa]" value="Roster Data Verification">
                                        <input type="hidden" name="kpas[5][result_indicators]" value="Verify weekly roster data to ensure alignment with actual attendance, and confirm next month's roster is uploaded by the last week">
                                    </td>
                                    <td>
                                        <div class="small">Verify weekly roster data to ensure alignment with actual attendance, and confirm next month's roster is uploaded by the last week</div>
                                        <div class="mt-1">
                                            <span class="badge bg-gray-100 text-gray-800 me-1">ND - 1</span>
                                            <span class="badge bg-gray-100 text-gray-800 me-1">NS - 2</span>
                                            <span class="badge bg-gray-100 text-gray-800 me-1">S - 3</span>
                                ...
                                <!-- WORK PERFORMANCE - Attendance Monitoring -->
                                <tr>
                                    <td class="fw-medium">
                                        <div class="d-flex align-items-center">
                                            <div class="bg-purple-100 text-purple-600 p-2 rounded me-2">
                                            ...
                                            <div>
                                                WORK PERFORMANCE
                                                <small class="text-muted d-block">Attendance Monitoring</small>
                                            </div>
                                        </div>
                                        <input type="hidden" name="kpas[6][category]" value="WORK PERFORMANCE">
                                        <input type="hidden" name="kpas[6][kpa]" value="Attendance Monitoring">
                                        <input type="hidden" name="kpas[6][result_indicators]" value="Conduct regular checks on attendance, leave, and overtime abnormalities, verify with stations, and complete timely corrections in the system">
                                    </td>
                                    <td>
                                        <div class="small">Conduct regular checks on attendance, leave, and overtime abnormalities, verify with stations, and complete timely corrections in the system</div>
                                        <div class="mt-1">
                                            <span class="badge bg-gray-100 text-gray-800 me-1">ND - 1</span>
                                            <span class="badge bg-gray-100 text-gray-800 me-1">NS - 2</span>
                                            <span class="badge bg-gray-100 text-gray-800 me-1">S - 3</span>
                                ...
                                <!-- WORK PERFORMANCE - Employee Welfare Activities -->
                                <tr>
                                    <td class="fw-medium">
                                        <div class="d-flex align-items-center">
                                            <div class="bg-purple-100 text-purple-600 p-2 rounded me-2">
                                            ...
                                            <div>
                                                WORK PERFORMANCE
                                                <small class="text-muted d-block">Employee Welfare Activities</small>
                                            </div>
                                        </div>
                                        <input type="hidden" name="kpas[7][category]" value="WORK PERFORMANCE">
                                        <input type="hidden" name="kpas[7][kpa]" value="Employee Welfare Activities">
                                        <input type="hidden" name="kpas[7][result_indicators]" value="Assist in organizing employee welfare and recognition activities, complete staff count verification, distribution, and maintain complete records">
                                    </td>
                                    <td>
                                        <div class="small">Assist in organizing employee welfare and recognition activities, complete staff count verification, distribution, and maintain complete records</div>
                                        <div class="mt-1">
                                            <span class="badge bg-gray-100 text-gray-800 me-1">ND - 1</span>
                                            <span class="badge bg-gray-100 text-gray-800 me-1">NS - 2</span>
                                            <span class="badge bg-gray-100 text-gray-800 me-1">S - 3</span>
                                ...
                                <!-- WORK PERFORMANCE - Process Improvement -->
                                <tr>
                                    <td class="fw-medium">
                                        <div class="d-flex align-items-center">
                                            <div class="bg-purple-100 text-purple-600 p-2 rounded me-2">
                                            ...
                                            <div>
                                                WORK PERFORMANCE
                                                <small class="text-muted d-block">Process Improvement</small>
                                            </div>
                                        </div>
                                        <input type="hidden" name="kpas[8][category]" value="WORK PERFORMANCE">
                                        <input type="hidden" name="kpas[8][kpa]" value="Process Improvement">
                                        <input type="hidden" name="kpas[8][result_indicators]" value="Propose improvements to payroll processes and system functions based on operational issues and participate in HR policy updates">
                                    </td>
                                    <td>
                                        <div class="small">Propose improvements to payroll processes and system functions based on operational issues and participate in HR policy updates</div>
                                        <div class="mt-1">
                                            <span class="badge bg-gray-100 text-gray-800 me-1">ND - 1</span>
                                            <span class="badge bg-gray-100 text-gray-800 me-1">NS - 2</span>
                                            <span class="badge bg-gray-100 text-gray-800 me-1">S - 3</span>
                                ...
                                <tr>
                                    <td class="fw-medium">
                                        ...
                                        <input type="hidden" name="kpas[9][category]" value="ATTITUDE">
                                        <input type="hidden" name="kpas[9][kpa]" value="Attitude">
                                        <input type="hidden" name="kpas[9][result_indicators]" value="Exhibit a proactive attitude, take initiative in tasks, and foster positive interactions with colleagues">
                                    </td>
                                    <td>
                                    ...
                                    <td class="weight-cell">
                                        <span class="weight-display">5%</span>
                                        <input type="hidden" name="kpas[9][weight]" value="5">
                                    </td>
                                    <td>
                    ...
                    <div class="confidentiality-section mb-4">
                        <div class="d-flex align-items-start gap-3">
                            <input type="checkbox" class="confidentiality-checkbox mt-1" id="confidentiality_acknowledgement" name="confidentiality_acknowledgement" value="1">
                            <div>
                                <label for="confidentiality_acknowledgement" class="fw-semibold mb-1">Confidentiality Acknowledgement</label>
                                <p class="small text-muted mb-0">I acknowledge that all information contained in this appraisal is confidential and will be handled in accordance with MOIC data protection policies. I understand that unauthorized disclosure of this information may result in disciplinary action.</p>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        const weights = [10, 25, 15, 10, 10, 5, 10, 5, 5, 5]; // Fixed weights
        ...
        function saveAsDraft(event) {
            ...
            document.getElementById('hrFormStatus').value = 'draft';
            ...
            setTimeout(() => {
                document.getElementById('hrAssistantForm').submit();
            }, 1500);
        }
        ...
        function submitForm(event) {
            ...
            // Check confidentiality acknowledgement
            const confidentialityCheckbox = document.getElementById('confidentiality_acknowledgement');
            if (confidentialityCheckbox && !confidentialityCheckbox.checked) {
                if (!confirm('You have not acknowledged the confidentiality requirement. Are you sure you want to continue without confidentiality acknowledgement?')) {
                    return;
                }
            }
            ...
            if (confirm(confirmationMessage)) {
                document.getElementById('hrFormStatus').value = 'submitted';
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Confidentiality checkbox styling
            const confidentialityCheckbox = document.getElementById('confidentiality_acknowledgement');
            if (confidentialityCheckbox) {
                confidentialityCheckbox.addEventListener('change', function() {
                    const confidentialitySection = this.closest('.confidentiality-section');
                    if (this.checked) {
                        confidentialitySection.classList.remove('border-red-300');
                        confidentialitySection.classList.add('border-indigo-200');
                    } else {
                        confidentialitySection.classList.remove('border-indigo-200');
                        confidentialitySection.classList.add('border-red-300');
                    }
                });
            }
